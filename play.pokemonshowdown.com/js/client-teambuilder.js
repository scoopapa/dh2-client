(function (exports, $) {
	...
	exports.TeambuilderRoom = exports.Room.extend({
		...
		renderSet: function (set, i) {
			...
			buf += '</div>';
			buf += '<div class="setchart" style="' + Dex.getTeambuilderSprite(set, this.curTeam.dex, this.curTeam.mod) + ';">';
		...
		updatePokemonSprite: function () {
			...
			this.$('.setchart').attr('style', Dex.getTeambuilderSprite(set, this.curTeam.dex, this.curTeam.mod));
