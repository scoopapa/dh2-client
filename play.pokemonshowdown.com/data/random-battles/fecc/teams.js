  ...
  getPriorityItem(ability, types, moves, counter, teamDetails, species, isLead, isDoubles, teraType, role) {
    ...
    if (role === "Mega") {
      ...
      if (mega === "blasgronmega") {
        if (moves.has("shellsmash") || moves.has("hydropump") || moves.has("icebeam") || moves.has("aurasphere") || moves.has("dragonpulse"))
          mega += "b";
        else
          mega += "a";
      }
    ...
    if (species.id === "chiruno" && moves.has("sheercold"))
      return "choicespecs";
    if (species.id === "espathrem" && moves.has("storedpower"))
      return "weaknesspolicy";
