...
class RandomTeams {
  ...
  getPriorityItem(ability, types, moves, counter, teamDetails, species, isLead, isDoubles, teraType, role) {
    if (!isLead && (species.id === "irontornado" && moves.has("acrobatics") || species.id === "ironmimic" || species.id === "irondirge" && role === "Setup Sweeper")) {
    ...
    if (moves.has("bellydrum") && moves.has("substitute"))
      return "Salac Berry";
    if (moves.has("swagger") && moves.has("acrobatics"))
      return "Mirror Herb";
  ...
  randomTeam() {
    ...
    while (baseSpeciesPool.length && pokemon.length < this.maxTeamSize) {
      ...
      if (set.ability === "Sand Stream" || set.ability === "Sand Wrath")
        teamDetails.sand = 1;
