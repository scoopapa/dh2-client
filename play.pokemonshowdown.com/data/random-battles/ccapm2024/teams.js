...
class RandomTeams {
  ...
  randomTeam() {
    ...
    while (baseSpeciesPool.length && pokemon.length < this.maxTeamSize) {
      ...
      if (species.baseSpecies === "Rizzquaza" && !teamDetails.trawlutre)
        teamDetails.rizzquaza = 1;
      if (species.baseSpecies === "Trawlutre" && !teamDetails.rizzquaza)
        teamDetails.trawlutre = 1;
      const types = species.types;
