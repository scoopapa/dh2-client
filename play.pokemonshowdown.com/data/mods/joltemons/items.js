...
const Items = {
  ...
  */
  ...
  morningblossom: {
    ...
    onTakeItem(item, source) {
      if (source.baseSpecies.baseSpecies === "Cherrim")
        return false;
      return true;
    },
    onUpdate(pokemon) {
  ...
  nightlightball: {
    ...
    onTakeItem(item, source) {
      if (source.baseSpecies.baseSpecies === "Mimikyu")
        return false;
      return true;
    },
    itemUser: ["Mimikyu"],
  ...
  seawaterbead: {
    ...
    onTakeItem(item, source) {
      if (source.baseSpecies.baseSpecies === "Phione")
        return false;
      return true;
    },
    itemUser: ["Phione"],
  ...
  sacredropes: {
    ...
    onTakeItem(item, source) {
      if (source.baseSpecies.baseSpecies === "Regigigas")
        return false;
      return true;
    },
    itemUser: ["Regigigas"],
