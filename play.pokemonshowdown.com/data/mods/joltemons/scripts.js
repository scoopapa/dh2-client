  ...
  pokemon: {
    ...
    isGrounded(negateImmunity = false) {
      ...
      if (!negateImmunity && this.hasType("Flying") && !(this.hasType("???") && "roost" in this.volatiles))
        return false;
      if ((this.hasAbility("levitate") || this.hasAbility("powerofalchemyweezing") || this.hasAbility("powerofalchemymismagius")) && !this.battle.suppressingAbility(this))
        return null;
    ...
    ignoringAbility() {
      ...
      if (this.volatiles["gastroacid"])
        return true;
      if (this.hasItem("Ability Shield") || this.ability === "neutralizinggas" || this.ability === "powerofalchemyweezing")
        return false;
      for (const pokemon of this.battle.getAllActive()) {
        if ((pokemon.ability === "neutralizinggas" || pokemon.ability === "powerofalchemyweezing") && !pokemon.volatiles["gastroacid"] && !pokemon.transformed && !pokemon.abilityState.ending && !this.volatiles["commanding"]) {
          return true;
        }
      }
      return false;
