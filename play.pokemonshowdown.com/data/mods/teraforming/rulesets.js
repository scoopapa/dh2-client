...
const Rulesets = {
  ...
  megadatamod: {
    ...
    onSwitchIn(pokemon) {
      if (pokemon.illusion) {
        if (pokemon.illusion.species.forme.startsWith("Mega") || pokemon.illusion.species.forme.startsWith("Tera") || pokemon.illusion.species.forme.startsWith("Ultra")) {
          this.add("-start", pokemon, "typechange", pokemon.illusion.getTypes(true).join("/"), "[silent]");
        }
      } else {
        if (pokemon.species.forme.startsWith("Mega") || pokemon.species.forme.startsWith("Tera") || pokemon.species.forme.startsWith("Ultra")) {
    ...
    onDamagingHit(damage, target, source, move) {
      if (target.hasAbility("illusion")) {
        if (target.species.forme.startsWith("Mega") || target.species.forme.startsWith("Tera") || target.species.forme.startsWith("Ultra")) {
