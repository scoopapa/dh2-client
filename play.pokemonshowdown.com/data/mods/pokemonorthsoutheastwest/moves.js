...
const Moves = {
  ...
  mistyterrain: {
    ...
    basePower: 0,
    category: "Status",
    shortDesc: "For five turns, Fairy powers up, Dragon moves are weakned, and grounded Pok\xE9mon can't get status conditions.",
    name: "Misty Terrain",
    pp: 10,
    priority: 0,
  ...
  shiningshot: {
    ...
    basePower: 40,
    basePowerCallback(pokemon2, target, move) {
      if (!pokemon2.volatiles["shiningshot"] || move.hit === 1) {
        pokemon2.addVolatile("shiningshot");
      }
      const bp = this.clampIntRange(move.basePower * pokemon2.volatiles["shiningshot"].multiplier, 1, 160);
      this.debug(`BP: ${bp}`);
      return bp;
    },
    category: "Special",
