  ...
  randomCCTeam() {
    ...
    for (let i = 0; i < 6; i++) {
      ...
      if (forme === "Smeargle") {
        ...
        let learnset = this.dex.data.Learnsets[species.id] && this.dex.data.Learnsets[species.id].learnset && !["pumpkaboosuper", "zygarde10"].includes(species.id) ? this.dex.data.Learnsets[species.id].learnset : this.dex.data.Learnsets[this.dex.species.get(species.baseSpecies).id].learnset;
        if (learnset) {
