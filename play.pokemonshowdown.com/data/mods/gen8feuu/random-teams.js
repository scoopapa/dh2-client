...
class RandomTeams {
  ...
  randomSet(species, teamDetails = {}, isLead = false, isDoubles = false) {
    ...
    if (species.requiredItems) {
      ...
      item = "Throat Spray";
    } else if ((this.dex.getEffectiveness("Rock", species) >= 1 && (!teamDetails.defog || ability === "Intimidate" || hasMove["uturn"] || hasMove["voltswitch"]) || hasMove["rapidspin"] && (ability === "Regenerator" || ability === "Surgeon Eye" || ability === "Growth Veil" || !!counter["recovery"])) && !isDoubles) {
      item = "Heavy-Duty Boots";
