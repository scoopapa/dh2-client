  ...
  */
  ...
  weirduck: {
    ...
    encounters: [
      ...
      //assuming you fish one up with a super rod; makes validation easier i think?
    ]
  },
  ribbito: {
    learnset: {
  ...
  nidoreign: {
    //Nidoreign is complicated. It's designed to be a convergent evolution, so it can have moves from Nidorina and Nidorino. 
    learnset: {
      scratch: ["1L1", "1L45"],
      //However, convergent evolution has never existed in Pokemon and thus has no routes on PS. So we have to get a little janky with this.
      growl: ["1L1", "1L45"],
      //They should remain incompatible with each sex's movesets but hey probably better to just not deal with it at all.
      tailwhip: ["1L1", "1L45"],
      bite: ["1L1", "1L45"],
      furyswipes: ["1L1", "1L45"],
      thrash: ["1L50"],
      //Ensuring Thrash doesn't become incompatible with Nidorino's moves either.
      megapunch: ["1M"],
      megakick: ["1M"],
      toxic: ["1M"],
      horndrill: ["1M"],
  ...
  decilla: {
    ...
    encounters: [
      ...
      //assuming ressurected from a fossil
    ]
  },
  gawarhed: {
    learnset: {
  ...
  omegadge: {
    ...
    encounters: [
      { generation: 1, level: 45 }
      //I'm imagining a Silph Co. superboss encounter.
    ]
  },
  trampel: {
    learnset: {
  ...
  ramoose: {
    learnset: {
      ...
      thunderwave: ["1L20", "1M"],
      razorleaf: ["1L22"],
      //yes it learns moves this fast the prototype was cracked
      supersonic: ["1L26"],
      takedown: ["1L29", "1M"],
      quickattack: ["1L33"],
      leer: ["1L37"],
      ...
      thrash: ["1L45"],
      growth: ["1L50"],
      //may remove this to liberate the levels a bit but it seems fine for now
      bodyslam: ["1M"],
      doubleedge: ["1M"],
      megadrain: ["1M"],
      solarbeam: ["1M"],
    ...
    encounters: [
      ...
      //no clue just validate the movepool and do what tajiri said
    ]
  },
  balumba: {
    learnset: {
      ...
      teleport: ["1M"],
      reflect: ["1M"],
      //this can probably be cut but it's on the sheet and seemed edge-case-y
      selfdestruct: ["1M"],
      swift: ["1M"],
      skullbash: ["1M"],
      dreameater: ["1M"],
  ...
  jabetta: {
    learnset: {
      peck: ["1L1"],
      bubble: ["1L1", "1L17"],
      //had the same learn levels iirc
      counter: ["1L19", "1L25", "1M"],
      bubblebeam: ["1L21", "1M"],
      lowkick: ["1L23"],
      jumpkick: ["1L32"],
  ...
  gavillain: {
    learnset: {
      ...
      bubblebeam: ["1M"],
      thunder: ["1M"],
      // was ice beam, changed in 1.4 for an electric/dragon approach.
      thunderbolt: ["1M"],
      // was blizzard, see above
      hyperbeam: ["1M"],
      submission: ["1M"],
      counter: ["1M"],
      seismictoss: ["1M"],
  ...
  gorochu: {
    learnset: {
      ...
      substitute: ["1M"],
      surf: ["1S0"]
      //didn't show in the builder once so keeping here
    }
  },
  guardia: {
    learnset: {
  ...
  bellignan: {
    // should just import everything from weepinbell
    learnset: {
      vinewhip: ["1L1"],
      growth: ["1L1"],
      lovelykiss: ["1L1"],
  ...
  melmetal: {
    learnset: {
      ...
      thunderpunch: ["1L20"],
      // technically evo but let's put it here.
      acidarmor: ["1L36"],
      magnetbomb: ["1L45"],
      megapunch: ["1L51", "1M"],
      smartstrike: ["1L63"],
  ...
  raichualola: {
    // pikachu stuff should get imported just fine, otherwise you'll need to add stuff
    learnset: {
      thundershock: ["1L1"],
      tailwhip: ["1L1"],
      growl: ["1L1"],
  ...
  exeggutoralola: {
    // should not need exeggcute's stuff
    learnset: {
      stomp: ["1L28"],
      takedown: ["1M"],
      doubleedge: ["1M"],
  ...
  articunogalar: {
    ...
    encounters: [
      { generation: 1, level: 50 }
      // moves may get pushed out in validation due to this level, revise if so
    ]
  },
  zapdosgalar: {
    learnset: {
  ...
  moltres: {
    // Fixed to have Flamethrower and Leer at once; fixes a weird error on cart
    learnset: {
