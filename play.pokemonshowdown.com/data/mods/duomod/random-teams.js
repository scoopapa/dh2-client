...
class RandomTeams {
  ...
  randomSet(species, teamDetails = {}, isLead = false, isDoubles = false) {
    ...
    if (species.requiredItems) {
      ...
      item = "Throat Spray";
    } else if ((this.dex.getEffectiveness("Electric", species) >= 1 && (!teamDetails.defog || ability === "Intimidate" || hasMove["uturn"] || hasMove["voltswitch"]) || hasMove["rapidspin"] && (ability === "Regenerator" || !!counter["recovery"])) && !isDoubles) {
      item = "Heavy-Duty Boots";
