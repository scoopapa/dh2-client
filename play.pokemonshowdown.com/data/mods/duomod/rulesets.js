  ...
  subscribeformorecontent: {
    ...
    onResidual(pokemon) {
      ...
      if (result === 0) {
        ...
        for (const pokemon2 of this.getAllActive()) {
          this.useMove("Spikes", pokemon2);
          this.useMove("Stealth Electric", pokemon2);
        }
      } else if (result === 6) {
        ...
        for (const pokemon2 of this.getAllActive()) {
          this.useMove("Conversion 2", pokemon2);
        }
      } else if (result === 11) {
        ...
        for (const pokemon2 of this.getAllActive()) {
          this.useMove("Octolock", pokemon2);
        }
      } else if (result === 38) {
        ...
        for (const pokemon2 of this.getAllActive()) {
          ...
          this.useMove(frstMove, pokemon2);
        }
      } else if (result === 43) {
        ...
        for (const pokemon2 of this.getAllActive()) {
          this.useMove("Roulette Spin", pokemon2);
        }
      } else if (result === 45) {
        ...
        for (const pokemon2 of this.sides[0].active) {
          for (const target of this.sides[1].active) {
            if (target.storedStats.spe < pokemon2.storedStats.spe) {
              this.useMove("Flame Runner", pokemon2);
