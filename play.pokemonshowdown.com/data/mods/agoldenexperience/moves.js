...
const Moves = {
  tentacatch: {
    ...
    onPrepareHit(target2, source2) {
      ...
      this.add("-anim", source2, "Toxic Thread", target2);
    },
    target: "normal",
    type: "Poison",
    contestType: "Tough"
  ...
  goodfishing: {
    ...
    priority: 0,
    flags: { contact: 1, protect: 1, mirror: 1 },
    onBasePower(basePower, source2, target2, move2) {
      const item = target2.getItem();
      if (!this.singleEvent("TakeItem", item, target2.itemState, target2, target2, move2, item))
        return;
      if (item.id) {
    ...
    onAfterHit(target2, source2) {
      if (source2.hp) {
        ...
        if (item) {
          this.add("-enditem", target2, item.name, "[from] move: Good Fishing", "[of] " + source2);
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Brave Bird", target2);
    },
    secondary: null,
    target: "normal",
    type: "Flying",
  ...
  magisterialwind: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Tailwind", target2);
    },
    secondary: null,
    target: "normal",
    type: "Flying",
  ...
  stellarpunch: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Dynamic Punch", target2);
    },
    secondary: null,
    target: "normal",
    type: "Fighting",
  ...
  toxicsting: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Poison Fang", target2);
    },
    target: "normal",
    type: "Poison"
  },
  ...
  dispelmagic: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Psyshock", target2);
    },
    secondary: null,
    target: "normal",
    type: "Psychic",
  ...
  draconicwrath: {
    ...
    accuracy: 100,
    basePower: 50,
    basePowerCallback(pokemon2, target2, move2) {
      if (!target2.newlySwitched) {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Outrage", target2);
    },
    secondary: null,
    target: "normal",
    type: "Dragon"
  ...
  purifyingstream: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Scald", target2);
    },
    secondary: null,
    target: "normal",
    type: "Water",
  ...
  railwaysmash: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Iron Head", target2);
    },
    target: "normal",
    type: "Steel"
  },
  goldenexperience: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Moonblast", target2);
    },
    secondary: null,
    target: "normal",
    type: "Fairy",
  ...
  dimensionalbleeding: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Hyperspace Fury", target2);
    },
    secondary: null,
    target: "normal",
    type: "Dark"
  ...
  frostbite: {
    ...
    condition: {
      onStart(target2) {
        ...
        this.add("-start", target2, "move: Frostbite");
      },
      onResidualOrder: 8,
      onResidual(pokemon2) {
        ...
        for (const target2 of this.getAllActive()) {
          if (pokemon2.volatiles["frostbite"]) {
            const damage = this.damage(this.clampIntRange(pokemon2.baseMaxhp / 16, 1) * this.effectState.stage, pokemon2, target2);
            if (damage) {
              this.heal(damage, target2, pokemon2);
            }
          }
    ...
    onTryImmunity(target2) {
      return !target2.hasType("Fire") && !target2.hasType("Ice");
    },
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
  ...
  underdog: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Facade", target2);
    },
    secondary: null,
    target: "normal",
    type: "Normal",
  ...
  flamingsphere: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Pyro Ball", target2);
    },
    secondary: null,
    target: "normal",
    type: "Fire",
  ...
  backfire: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Overheat", target2);
    },
    secondary: null,
    target: "normal",
    type: "Fire",
  ...
  highwater: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Life Dew", target2);
    },
    secondary: null,
    target: "self",
    type: "Water",
  ...
  seajaws: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Fishious Rend", target2);
    },
    secondary: null,
  ...
  parallelcircuit: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Bolt Beak", target2);
    },
    secondary: null,
    target: "normal",
    type: "Electric",
  ...
  condensate: {
    ...
    onBasePower(basePower, source2) {
      if (this.field.isTerrain("mistyterrain") && source2.isGrounded()) {
        this.debug("terrain buff");
        return this.chainModify(2);
      }
    },
    onModifyMove(move2, source2, target2) {
      if (this.field.isTerrain("mistyterrain") && source2.isGrounded()) {
  ...
  monkeypunch: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Close Combat", target2);
    },
    secondary: null,
    target: "normal",
    type: "Fighting",
  ...
  indomitablespirit: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Vacuum Wave", target2);
    },
    condition: {
      ...
      onModifyDamage(damage, source2, target2, move2) {
        if (target2.getMoveHitData(move2).typeMod < 0) {
  ...
  musclecare: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Bulk Up", target2);
    },
    secondary: null,
    target: "self",
    type: "Fighting",
  ...
  dissolution: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Acid Spray", target2);
    },
    secondary: null,
    target: "allAdjacentFoes",
    type: "Poison"
  ...
  landslide: {
    ...
    onHit(target2, source2, move2) {
      let success = false;
      if (!target2.volatiles["substitute"] || move2.infiltrates)
      ...
      for (const targetCondition of removeTarget) {
        if (target2.side.removeSideCondition(targetCondition)) {
          if (!removeAll.includes(targetCondition))
            continue;
          this.add("-sideend", target2.side, this.dex.conditions.get(targetCondition).name, "[from] move: Landslide", "[of] " + source2);
          success = true;
        }
      }
      for (const sideCondition of removeAll) {
        if (source2.side.removeSideCondition(sideCondition)) {
          this.add("-sideend", source2.side, this.dex.conditions.get(sideCondition).name, "[from] move: Landslide", "[of] " + source2);
          success = true;
        }
      }
      return success;
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Mud Shot", target2);
    },
    target: "normal",
    type: "Ground",
    contestType: "Tough"
  ...
  epicenter: {
    ...
    onTry(source2, target2) {
      ...
      this.add("-start", source2, "move: Epicenter");
      return null;
    },
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
  ...
  downdraft: {
    ...
    priority: 0,
    flags: { protect: 1, mirror: 1 },
    onAfterHit(target2, source2, move2) {
      if (!target2.isGrounded()) {
        this.boost({ spe: -1 }, target2, target2, null, true);
      }
    },
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Hurricane", target2);
    },
    secondary: null,
    target: "any",
    type: "Flying",
  ...
  clearmind: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Calm Mind", target2);
    },
    secondary: null,
    target: "self",
    type: "Psychic",
  ...
  golemstrike: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Rock Wrecker", target2);
    },
    target: "normal",
    type: "Rock",
    contestType: "Tough"
  ...
  punishingblow: {
    ...
    priority: 0,
    flags: { contact: 1, protect: 1, mirror: 1 },
    onModifyMove(move2, pokemon2, target2) {
      let hasBoost = false;
      let i;
      if (!target2)
        return;
  ...
  contrariety: {
    ...
    secondary: null,
    onPrepareHit(target2, source2, move2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Torment", target2, source2);
    },
    target: "all",
    type: "Dark",
    zMove: { boost: { def: 1 } }
  ...
  blackflash: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Night Daze", target2);
    },
    secondary: null,
    target: "normal",
  ...
  hypnotichorror: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Hypnosis", target2);
  ...
  sneakyassault: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Lash Out", target2);
    },
    target: "normal",
    type: "Dark",
    contestType: "Cool"
  ...
  mercuryshot: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Flash Cannon", target2);
    },
    target: "normal",
    type: "Steel",
    contestType: "Tough"
  ...
  sweetheart: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Dazzling Gleam", target2);
    },
  ...
  chakraterrain: {
    ...
    condition: {
      ...
      onBasePower(basePower, attacker, defender, move2) {
        if ((move2.type === "Fighting" || move2.flags["pulse"]) && attacker.isGrounded() && !attacker.isSemiInvulnerable()) {
          this.debug("chakra terrain boost");
          return this.chainModify([5325, 4096]);
        }
      },
      onAnyAccuracy(accuracy, target2, source2, move2) {
        if (move2.type === "Fighting" && source2.isGrounded() && !source2.isSemiInvulnerable()) {
          return true;
        }
        return accuracy;
      },
      onFieldStart(field, source2, effect) {
        if (effect?.effectType === "Ability") {
          this.add("-fieldstart", "move: Chakra Terrain", "[from] ability: " + effect.name, "[of] " + source2);
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Psychic Terrain", target2);
    },
    secondary: null,
    target: "all",
    type: "Fighting",
  ...
  naturepower: {
    ...
    onTryHit(target2, pokemon2) {
      ...
      this.actions.useMove(move2, pokemon2, target2);
      return null;
    }
  },
  terrainpulse: {
  ...
  camouflage: {
    ...
    onHit(target2) {
      ...
      if (target2.hasItem("identitycard"))
        return false;
      if (target2.getTypes().join() === newType || !target2.setType(newType))
        return false;
      this.add("-start", target2, "typechange", newType);
    }
  },
  dragonpulse: {
    inherit: true,
  ...
  bittermalice: {
    ...
    basePower: 60,
    basePowerCallback(pokemon2, target2, move2) {
      if (target2.status === "frz" || target2.hasAbility("comatose"))
        return move2.basePower * 2;
      return move2.basePower;
    },
  ...
  shelter: {
    ...
    onTryHit(target2, source2, move2) {
      return !!this.queue.willAct() && this.runEvent("StallMove", target2);
    },
    onHit(pokemon2) {
      ...
      onTryHit(target2, source2, move2) {
        if (!move2.flags["protect"]) {
          if (move2.isZ || move2.isMax && !move2.breaksProtect)
            target2.getMoveHitData(move2).zBrokeProtect = true;
          return;
        }
        ...
        if (move2.flags["contact"]) {
          source2.clearBoosts();
          this.add("-clearboost", source2);
        }
        return this.NOT_FAIL;
      },
      onHit(target2, source2, move2) {
        if (move2.isZOrMaxPowered && move2.flags["contact"]) {
          source2.clearBoosts();
          this.add("-clearboost", source2);
        }
      }
  ...
  guillotine: {
    ...
    pp: 10,
    onAfterMoveSecondarySelf(pokemon2, target2, move2) {
      if (!target2 || target2.fainted || target2.hp <= 0)
        this.boost({ atk: 1 }, pokemon2, pokemon2, move2);
    }
  },
  horndrill: {
    inherit: true,
  ...
  lightningassault: {
    ...
    accuracy: 100,
    basePower: 0,
    basePowerCallback(pokemon2, target2) {
      let ratio = Math.floor(pokemon2.getStat("spe") / target2.getStat("spe"));
      if (!isFinite(ratio))
        ratio = 0;
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Spark", target2);
    },
    target: "normal",
    type: "Flying",
    zMove: { basePower: 160 },
  ...
  conversionz: {
    ...
    onTryHit(pokemon2, target2, move2) {
      if (pokemon2.item) {
        return false;
      }
    ...
    onHit(target2) {
      const type = this.dex.moves.get(target2.moveSlots[2].id).type;
      if (target2.hasType(type) || !target2.setType(type))
        return false;
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Conversion", target2);
    },
    secondary: null,
    target: "self",
    type: "Normal"
  ...
  zawall: {
    ...
    onTryMove(attacker, defender, move2) {
      ...
      this.boost({ atk: 1 }, attacker, attacker, move2);
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Head Smash", target2);
    },
    secondary: null,
    target: "normal",
    type: "Rock"
  ...
  awakening: {
    ...
    heal: [1, 2],
    onHit(pokemon2) {
      for (const target2 of pokemon2.side.foe.active) {
        if (target2.fainted)
          return;
        const temp = this.sample(target2.moveSlots);
        this.add("-message", pokemon2.name + "'s Awakening revealed the move " + temp.move + "!");
      }
    },
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Dream Eater", target2);
    },
    secondary: null,
    target: "self",
    type: "Psychic",
  ...
  fulldevotion: {
    ...
    condition: {
      ...
      onStart(target2, source2) {
        ...
        this.add("-singleturn", target2, "Full Devotion", "[of] " + source2);
      },
      ...
      onDamagingHit(damage, target2, source2, move2) {
        if (source2.side !== target2.side) {
          return damage *= 0.75;
        }
      }
    },
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Psystrike", target2);
    },
    secondary: null,
    target: "adjacentAlly",
    type: "Psychic",
  ...
  braveblade: {
    ...
    onModifyMove(move2, pokemon2, target2) {
      ...
      const def = target2.getStat("def", false, true);
      const spd = target2.getStat("spd", false, true);
    ...
    onHit(target2, source2, move2) {
      this.hint(move2.category + " Brave Blade");
    },
    onAfterSubDamage(damage, target2, source2, move2) {
      this.hint(move2.category + " Brave Blade");
    },
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
  ...
  happydance: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Rain Dance", target2);
    },
    secondary: null,
    target: "all",
    type: "Water",
  ...
  houndshowl: {
    ...
    onTryHit(target2, pokemon2) {
      target2.side.removeSideCondition("houndshowl");
    },
    condition: {
      duration: 1,
      onBeforeSwitchOut(pokemon2) {
        ...
        for (const source2 of this.effectState.sources) {
          if (!source2.isAdjacent(pokemon2) || !this.queue.cancelMove(source2) || !source2.hp)
            continue;
          if (!alreadyAdded) {
          ...
          this.actions.runMove("houndshowl", source2, source2.getLocOf(pokemon2));
        }
      }
    },
    onPrepareHit(target2, source2) {
  ...
  dantesinferno: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Inferno", target2);
    },
    secondary: null,
    target: "normal",
    type: "Fire"
  ...
  swarming: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Bug Buzz", target2);
    },
    target: "normal",
    type: "Bug",
    contestType: "Smart"
  ...
  ragefist: {
    ...
    basePowerCallback(pokemon2) {
      return Math.min(100, 50 + 50 * pokemon2.timesAttacked);
    },
  ...
  roguewave: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Wave Crash", target2);
    },
    target: "normal",
    type: "Water",
    contestType: "Cool"
  ...
  natureswrath: {
    ...
    onModifyType(move2, pokemon2) {
      for (const target2 of pokemon2.side.foe.active) {
        const type1 = "Grass";
        const type2 = "Ground";
        if (this.dex.getEffectiveness(type1, target2) < this.dex.getEffectiveness(type2, target2)) {
          move2.type = "Ground";
        } else if (target2.hasType("Flying") || target2.hasAbility("eartheater") || target2.hasAbility("levitate")) {
          move2.type = "Grass";
        } else if (target2.hasAbility("sapsipper")) {
          move2.type = "Ground";
        } else if (this.dex.getEffectiveness(type1, target2) === this.dex.getEffectiveness(type2, target2)) {
    ...
    onHit(target2, source2, move2) {
      this.add("-message", `Nature's Wrath dealt ${move2.type}-type damage!`);
    },
    priority: 0,
    secondary: null,
    target: "any",
  ...
  magicmissile: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Swift", target2);
    },
    basePowerCallback(pokemon2, target2, move2) {
      if (target2.getMoveHitData(move2).typeMod < 0) {
  ...
  healblock: {
    ...
    condition: {
      ...
      onBeforeMove(pokemon2, target2, move2) {
        if (move2.flags["heal"] && !move2.isZ && !move2.isMax) {
          this.add("cant", pokemon2, "move: Heal Block", move2);
          return false;
        }
      },
      onModifyMove(move2, pokemon2, target2) {
      ...
      onRestart(target2, source2, effect) {
  ...
  fatbombing: {
    ...
    onTryMove(attacker, defender, move2) {
      ...
      if (this.field.getPseudoWeather("gravity")) {
        this.attrLastMove("[still]");
        this.addMove("-anim", attacker, move2.name, defender);
        return;
      }
      if (!this.runEvent("ChargeMove", attacker, defender, move2)) {
        return;
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Rock Blast", target2);
    },
    secondary: null,
    hasSheerForce: true,
    target: "normal",
  ...
  poisonivy: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Power Whip", target2);
      this.add("-anim", source2, "Sludge Wave", target2);
    },
    secondary: null,
    target: "normal",
    type: "Poison",
  ...
  clusterexplosion: {
    ...
    onPrepareHit(target2, pokemon2, move2) {
      this.attrLastMove("[still]");
      this.add("-anim", pokemon2, "Splintered Stormshards", pokemon2);
    },
    onTryMove(source2, target2, move2) {
  ...
  froststorm: {
    ...
    onModifyMove(move2, pokemon2, target2) {
      if (target2 && ["hail", "snow", "everlastingwinter"].includes(target2.effectiveWeather())) {
        move2.secondaries.push({
          chance: 100,
          status: "frz"
        });
  ...
  thunderstorm: {
    ...
    flags: { protect: 1, mirror: 1, metronome: 1, wind: 1 },
    onModifyMove(move2, pokemon2, target2) {
      if (target2 && ["raindance", "primordialsea"].includes(target2.effectiveWeather())) {
        move2.secondaries.push({
          chance: 100,
          status: "par"
        });
  ...
  heatstorm: {
    ...
    flags: { protect: 1, mirror: 1, metronome: 1, wind: 1 },
    onModifyMove(move2, pokemon2, target2) {
      if (target2 && ["sunnyday", "desolateland"].includes(target2.effectiveWeather())) {
        move2.secondaries.push({
          chance: 100,
          status: "brn"
        });
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Hurricane", target2);
      this.add("-anim", source2, "Heat Wave", target2);
    },
    secondary: {
      chance: 30,
      status: "brn"
  ...
  genesiswave: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Genesis Supernova", target2);
    },
    secondary: null,
    target: "self",
    type: "Psychic",
  ...
  thunderway: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Thunderclap", source2);
    },
    secondary: null,
    target: "self",
    type: "Electric",
  ...
  fieryfire: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Fiery Dance", source2);
    },
    secondary: null,
    target: "self",
    type: "Fire",
  ...
  auroraborealis: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Aurora Veil", source2);
      this.add("-anim", source2, "Aqua Ring", source2);
    },
    secondary: null,
    target: "self",
    type: "Water",
  ...
  boulderbuilding: {
    ...
    onHit(target2, source2, move2) {
      let success = false;
      if (!target2.volatiles["substitute"] || move2.infiltrates)
        success = !!this.boost({ def: 1 }, source2, source2, this.dex.getActiveMove("Boulder Building"));
      const removeTarget = [
        "reflect",
        "lightscreen",
        "auroraveil",
      ...
      for (const targetCondition of removeTarget) {
        if (target2.side.removeSideCondition(targetCondition)) {
          if (!removeAll.includes(targetCondition))
            continue;
          this.add("-sideend", target2.side, this.dex.conditions.get(targetCondition).name, "[from] move: Boulder Building", "[of] " + source2);
          success = true;
        }
      }
      for (const sideCondition of removeAll) {
        if (source2.side.removeSideCondition(sideCondition)) {
          this.add("-sideend", source2.side, this.dex.conditions.get(sideCondition).name, "[from] move: Boulder Building", "[of] " + source2);
          success = true;
        }
      }
      this.field.clearTerrain();
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Rock Blast", source2);
    },
    secondary: null,
    target: "normal",
    type: "Rock",
  ...
  icebergpolish: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Rock Polish", source2);
    },
    secondary: null,
    target: "self",
    type: "Ice",
  ...
  alienmetal: {
    ...
    condition: {
      ...
      onSourceModifyDamage(damage, source2, target2, move2) {
        if (target2.getMoveHitData(move2).typeMod > 0) {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Iron Defense", source2);
    },
    secondary: null,
    target: "allies",
    type: "Steel",
  ...
  athosrapier: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Smart Strike", source2);
    ...
    condition: {
      ...
      onTryHit(target2, source2, move2) {
        ...
        if (this.checkMoveMakesContact(move2, source2, target2)) {
          this.boost({ def: 1 }, target2, target2, this.dex.getActiveMove("Athos Rapier"));
        }
        return this.NOT_FAIL;
      },
      onHit(target2, source2, move2) {
        if (move2.isZOrMaxPowered && this.checkMoveMakesContact(move2, source2, target2)) {
          this.boost({ def: 1 }, target2, target2, this.dex.getActiveMove("Athos Rapier"));
        }
      }
    },
  ...
  aramisdagger: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Leaf Blade", target2);
    },
    secondary: null,
    target: "normal",
    type: "Grass",
  ...
  porthosbroadsword: {
    ...
    beforeMoveCallback(pokemon2) {
      if (pokemon2.volatiles["focuspunch"]?.lostFocus) {
        this.add("cant", pokemon2, "Porthos Broadsword", "Porthos Broadsword");
        return true;
      }
    },
    condition: {
      duration: 1,
      onStart(pokemon2) {
        this.add("-singleturn", pokemon2, "move: Porthos Broadsword");
      },
      onHit(pokemon2, source2, move2) {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Stone Edge", target2);
    },
    secondary: null,
    target: "normal",
    type: "Rock",
  ...
  befuddlepowder: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "G-Max Befuddle", target2);
    },
    secondary: null,
    target: "adjacentFoe",
    type: "Flying",
  ...
  piercingdart: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Pin Missile", target2);
    },
    secondary: null,
    target: "normal",
    type: "Poison"
  ...
  hindenburg: {
    ...
    basePower: 65,
    basePowerCallback(pokemon2, target2, move2) {
      if (!pokemon2.item || pokemon2.status === "brn") {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Sky Drop", target2);
      this.add("-anim", source2, "Explosion", target2);
    },
    category: "Special",
    name: "Hindenburg",
    pp: 15,
  ...
  ventilation: {
    ...
    basePower: 70,
    basePowerCallback(pokemon2) {
      if (pokemon2.volatiles["stockpile"]?.layers === 3)
    ...
    onAfterMove(pokemon2) {
      if (pokemon2.volatiles["stockpile"])
  ...
  emushdance: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Zen Headbutt", target2);
    },
    secondary: null,
    hasSheerForce: true,
    target: "normal",
  ...
  rainofarrows: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Icicle Spear", target2);
      this.add("-anim", source2, "Thousand Arrows", target2);
    },
    onHit(pokemon2, source2) {
      source2.addVolatile("rainofarrows");
    },
    condition: {
      duration: 1,
      onResidual(pokemon2) {
  ...
  wyvernflight: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Boomburst", target2);
  ...
  ningencry: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Snowscape", target2);
    },
    secondary: null,
    target: "all",
    type: "Ice",
  ...
  timeparadox: {
    ...
    onPrepareHit(target2, source2) {
      this.attrLastMove("[still]");
      this.add("-anim", source2, "Psywave", target2);
    },
    target: "normal",
    type: "Psychic",
    contestType: "Tough",
  ...
  dig: {
    ...
    condition: {
      ...
      onInvulnerability(target2, source2, move2) {
        if (["earthquake", "magnitude"].includes(move2.id)) {
          return;
        }
        return false;
      },
      onSourceModifyDamage(damage, source2, target2, move2) {
        if (move2.id === "earthquake" || move2.id === "magnitude") {
          return this.chainModify(2);
        }
      }
    }
  ...
  dive: {
    ...
    onTryMove(attacker, defender, move2) {
      ...
      if (attacker.hasAbility("gulpmissile") && attacker.species.name === "Cramorant" && !attacker.transformed) {
        attacker.formeChange("cramorantgulping", move2);
      }
      this.add("-prepare", attacker, move2.name);
      if (!this.runEvent("ChargeMove", attacker, defender, move2)) {
        return;
    ...
    condition: {
      ...
      onInvulnerability(target2, source2, move2) {
        if (["surf", "whirlpool"].includes(move2.id)) {
          return;
        }
        return false;
      },
      onSourceModifyDamage(damage, source2, target2, move2) {
        if (move2.id === "surf" || move2.id === "whirlpool") {
          return this.chainModify(2);
        }
      }
    }
  ...
  solarbeam: {
    inherit: true,
    onBasePower(basePower, pokemon2, target2) {
  ...
  wish: {
    ...
    condition: {
      duration: 2,
      onStart(pokemon2, source2) {
        if (source2.hasAbility("karma")) {
          this.effectState.hp = 3 * source2.maxhp / 4;
        } else {
      ...
      onResidualOrder: 4,
      onEnd(target2) {
        if (target2 && !target2.fainted) {
          const damage = this.heal(this.effectState.hp, target2, target2);
          if (damage) {
            this.add("-heal", target2, target2.getHealth, "[from] move: Wish", "[wisher] " + this.effectState.source.name);
          }
        }
      }
    }
  ...
  wakeupslap: {
    inherit: true,
    basePowerCallback(pokemon2, target2, move2) {
      if (target2.status === "slp" || target2.hasAbility("comatose") || this.field.getPseudoWeather("endlessdream"))
        return move2.basePower * 2;
      return move2.basePower;
    }
  },
  dreameater: {
    inherit: true,
    onTryImmunity(target2, source2) {
      return target2.status === "slp" || target2.hasAbility("comatose") || this.field.getPseudoWeather("endlessdream");
    }
  },
  nightmare: {
    inherit: true,
  ...
  sleeptalk: {
    ...
    onTry(source2) {
      let usable = false;
      for (const opponent of source2.adjacentFoes()) {
        if (this.field.getPseudoWeather("endlessdream")) {
          usable = true;
          break;
        }
      }
      return source2.status === "slp" || source2.hasAbility("comatose") || usable;
    }
  },
  // Blowhole
  waterspout: {
    inherit: true,
    basePowerCallback(pokemon2, target2, move2) {
      if (pokemon2.hasAbility("blowhole"))
        return 150;
      const bp = move2.basePower * pokemon2.hp / pokemon2.maxhp;
      this.debug("BP: " + bp);
      return bp;
    }
  }
