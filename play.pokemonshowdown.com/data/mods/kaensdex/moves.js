...
const Moves = {
  ...
  hunt: {
    ...
    self: {
      onHit(source) {
        for (const pokemon2 of source.side.active) {
          pokemon2.addVolatile("hunt");
        }
      }
    },
    condition: {
  ...
  windblade: {
    ...
    self: {
      onHit(source) {
        for (const pokemon2 of source.side.active) {
          pokemon2.addVolatile("windblade");
        }
      }
    },
    condition: {
  ...
  cleaning: {
    ...
    onHit(pokemon2) {
      ...
      return !!this.heal(this.modify(pokemon2.maxhp, factor));
    },
    secondary: null,
    target: "self",
    type: "Fairy",
  ...
  floorcleaning: {
    ...
    onAfterHit(target, pokemon2) {
      ...
      for (const condition of sideConditions) {
        if (pokemon2.hp && pokemon2.side.removeSideCondition(condition)) {
          this.add("-sideend", pokemon2.side, this.dex.conditions.get(condition).name, "[from] move: Floor Cleaning", "[of] " + pokemon2);
        }
      }
    ...
    onAfterSubDamage(damage, target, pokemon2) {
      if (pokemon2.hp && pokemon2.removeVolatile("leechseed")) {
        this.add("-end", pokemon2, "Leech Seed", "[from] move: Rapid Spin", "[of] " + pokemon2);
      }
      const sideConditions = ["spikes", "toxicspikes", "stealthrock", "stickyweb", "gmaxsteelsurge", "electricspores", "icetrap"];
  ...
  fightingspirit: {
    ...
    onHit(target, source, move) {
      if (!target.setStatus("brn", source, move))
        return false;
    },
    boosts: {
      spd: 1,
  ...
  blazingspin: {
    ...
    onAfterHit(target, pokemon2) {
      if (pokemon2.hp && pokemon2.removeVolatile("leechseed")) {
        this.add("-end", pokemon2, "Leech Seed", "[from] move: Blazing Spin", "[of] " + pokemon2);
      }
      const sideConditions = ["spikes", "toxicspikes", "stealthrock", "stickyweb", "gmaxsteelsurge", "electricspores", "icetrap"];
      for (const condition of sideConditions) {
        if (pokemon2.hp && pokemon2.side.removeSideCondition(condition)) {
          this.add("-sideend", pokemon2.side, this.dex.conditions.get(condition).name, "[from] move: Blazing Spin", "[of] " + pokemon2);
        }
      }
      if (pokemon2.hp && pokemon2.volatiles["partiallytrapped"]) {
        pokemon2.removeVolatile("partiallytrapped");
  ...
  concert: {
    ...
    onTryMove(pokemon2, target, move) {
      if (pokemon2.species.name === "Vizcachu-Mega" || move.hasBounced) {
        return;
      }
      this.add("-fail", pokemon2, "move: Concert");
    ...
    onHit(pokemon2) {
      const oldAbility = pokemon2.setAbility("dancer");
      if (oldAbility) {
        this.add("-ability", pokemon2, "Dancer", "[from] move: Concert");
        return;
      }
      return false;
    },
  ...
  electricspores: {
    ...
    condition: {
      ...
      onSwitchIn(pokemon2) {
        if (pokemon2.hasItem("heavydutyboots") || pokemon2.hasItem("safetygoggles") || pokemon2.hasAbility("overcoat"))
          return;
        if (pokemon2.hasType("Electric") || pokemon2.hasType("Grass") || pokemon2.hasAbility("Climber")) {
          this.add("-sideend", pokemon2.side, "move: Electric Spores", "[of] " + pokemon2);
          pokemon2.side.removeSideCondition("electricspores");
        } else {
          const typeMod = this.clampIntRange(pokemon2.runEffectiveness(this.dex.getActiveMove("electricspores")), -6, 6);
  ...
  icetrap: {
    ...
    condition: {
      ...
      onSwitchIn(pokemon2) {
        if (pokemon2.hasItem("heavydutyboots") || pokemon2.hasAbility("coldheart"))
          return;
        if (pokemon2.hasType("Fire") || pokemon2.hasAbility("Climber")) {
          this.add("-sideend", pokemon2.side, "move: Ice Trap", "[of] " + pokemon2);
          pokemon2.side.removeSideCondition("icetrap");
        } else {
          const typeMod = this.clampIntRange(pokemon2.runEffectiveness(this.dex.getActiveMove("icetrap")), -6, 6);
          this.damage(pokemon2.maxhp * Math.pow(2, typeMod) / 8);
        }
      }
    },
  ...
  shellburst: {
    ...
    onHit(target, pokemon2, move) {
      if (pokemon2.species.id === "guerrevo" && !pokemon2.transformed) {
        move.willChangeForme = true;
      }
    },
    onAfterMoveSecondarySelf(pokemon2, target, move) {
      if (move.willChangeForme) {
        const guerrevoForme = pokemon2.species.id === "guerrevonacer" ? "" : "-Nacer";
        pokemon2.formeChange("Guerrevo" + guerrevoForme, this.effect, false, "[msg]");
      }
    },
    target: "normal",
    type: "Rock",
    ...
    condition: {
      ...
      onSwitchIn(pokemon2) {
        if (pokemon2.hasItem("heavydutyboots"))
          return;
        if (pokemon2.hasAbility("Climber")) {
          this.add("-sideend", pokemon2.side, "move: Stealth Rock", "[of] " + pokemon2);
          pokemon2.side.removeSideCondition("stealthrock");
        } else {
    ...
    condition: {
      ...
      onSwitchIn(pokemon2) {
        if (!pokemon2.isGrounded())
          return;
        if (pokemon2.hasType("Poison") || pokemon2.hasAbility("Climber")) {
    ...
    condition: {
      ...
      onSwitchIn(pokemon2) {
        ...
        if (pokemon2.hasItem("heavydutyboots"))
          return;
        if (pokemon2.hasAbility("Climber")) {
          this.add("-sideend", pokemon2.side, "move: Spikes", "[of] " + pokemon2);
          pokemon2.side.removeSideCondition("spikes");
        } else {
    ...
    condition: {
      ...
      onSwitchIn(pokemon2) {
        ...
        if (pokemon2.hasItem("heavydutyboots"))
          return;
        if (pokemon2.hasAbility("Climber")) {
          this.add("-sideend", pokemon2.side, "move: Sticky Web", "[of] " + pokemon2);
          pokemon2.side.removeSideCondition("stickyweb");
        } else {
    ...
    condition: {
      ...
      onSwitchIn(pokemon2) {
        if (pokemon2.hasItem("heavydutyboots"))
          return;
        if (pokemon2.hasAbility("Climber")) {
          this.add("-sideend", pokemon2.side, "move: G-Max Steelsurge", "[of] " + pokemon2);
          pokemon2.side.removeSideCondition("gmaxsteelsurge");
        } else {
  ...
  hyperbeam: {
    ...
    condition: {
      onDisableMove(pokemon2) {
        if (pokemon2.lastMove?.id === "hyperbeam")
          pokemon2.disableMove("hyperbeam");
      }
    },
    beforeMoveCallback(pokemon2) {
      if (pokemon2.lastMove?.id === "hyperbeam")
        pokemon2.addVolatile("hyperbeam");
    },
    secondary: null,
    target: "normal",
    type: "Normal",
  ...
  gigaimpact: {
    ...
    condition: {
      onDisableMove(pokemon2) {
        if (pokemon2.lastMove?.id === "gigaimpact")
          pokemon2.disableMove("gigaimpact");
      }
    },
    beforeMoveCallback(pokemon2) {
      if (pokemon2.lastMove?.id === "gigaimpact")
        pokemon2.addVolatile("gigaimpact");
    },
    secondary: null,
    target: "normal",
    type: "Normal",
  ...
  blastburn: {
    ...
    condition: {
      onDisableMove(pokemon2) {
        if (pokemon2.lastMove?.id === "blastburn")
          pokemon2.disableMove("blastburn");
      }
    },
    beforeMoveCallback(pokemon2) {
      if (pokemon2.lastMove?.id === "blastburn")
        pokemon2.addVolatile("blastburn");
    },
    secondary: null,
    target: "normal",
    type: "Fire",
  ...
  hydrocannon: {
    ...
    condition: {
      onDisableMove(pokemon2) {
        if (pokemon2.lastMove?.id === "hydrocannon")
          pokemon2.disableMove("hydrocannon");
      }
    },
    beforeMoveCallback(pokemon2) {
      if (pokemon2.lastMove?.id === "hydrocannon")
        pokemon2.addVolatile("hydrocannon");
    },
    secondary: null,
    target: "normal",
    type: "Water",
  ...
  frenzyplant: {
    ...
    condition: {
      onDisableMove(pokemon2) {
        if (pokemon2.lastMove?.id === "frenzyplant")
          pokemon2.disableMove("frenzyplant");
      }
    },
    beforeMoveCallback(pokemon2) {
      if (pokemon2.lastMove?.id === "frenzyplant")
        pokemon2.addVolatile("frenzyplant");
    },
    secondary: null,
    target: "normal",
    type: "Grass",
  ...
  meteorassault: {
    ...
    condition: {
      onDisableMove(pokemon2) {
        if (pokemon2.lastMove?.id === "meteorassault")
          pokemon2.disableMove("meteorassault");
      }
    },
    beforeMoveCallback(pokemon2) {
      if (pokemon2.lastMove?.id === "meteorassault")
        pokemon2.addVolatile("meteorassault");
    },
    secondary: null,
    target: "normal",
    type: "Fighting"
  ...
  roaroftime: {
    ...
    condition: {
      onDisableMove(pokemon2) {
        if (pokemon2.lastMove?.id === "roaroftime")
          pokemon2.disableMove("roaroftime");
      }
    },
    beforeMoveCallback(pokemon2) {
      if (pokemon2.lastMove?.id === "roaroftime")
        pokemon2.addVolatile("roaroftime");
    },
    secondary: null,
    target: "normal",
    type: "Dragon",
  ...
  rockwrecker: {
    ...
    condition: {
      onDisableMove(pokemon2) {
        if (pokemon2.lastMove?.id === "rockwrecker")
          pokemon2.disableMove("rockwrecker");
      }
    },
    beforeMoveCallback(pokemon2) {
      if (pokemon2.lastMove?.id === "rockwrecker")
        pokemon2.addVolatile("rockwrecker");
    },
    secondary: null,
    target: "normal",
    type: "Rock",
  ...
  prismaticlaser: {
    ...
    condition: {
      onDisableMove(pokemon2) {
        if (pokemon2.lastMove?.id === "prismaticlaser")
          pokemon2.disableMove("prismaticlaser");
      }
    },
    beforeMoveCallback(pokemon2) {
      if (pokemon2.lastMove?.id === "prismaticlaser")
        pokemon2.addVolatile("prismaticlaser");
    },
    secondary: null,
    target: "normal",
    type: "Psychic",
  ...
  chloroblast: {
    ...
    onAfterMove(pokemon2, target, move) {
      if (move.mindBlownRecoil && !move.multihit) {
        ...
        this.damage(Math.round(pokemon2.maxhp / 2), pokemon2, pokemon2, this.dex.conditions.get("Chloroblast"), true);
  ...
  gigatonhammer: {
    ...
    condition: {
      onDisableMove(pokemon2) {
        if (pokemon2.lastMove?.id === "gigatonhammer")
          pokemon2.disableMove("gigatonhammer");
      }
    },
    beforeMoveCallback(pokemon2) {
      if (pokemon2.lastMove?.id === "gigatonhammer")
        pokemon2.addVolatile("gigatonhammer");
    },
    onAfterMove(pokemon2) {
      if (pokemon2.removeVolatile("gigatonhammer")) {
