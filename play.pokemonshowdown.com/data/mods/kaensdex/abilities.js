...
const Abilities = {
  success: {
    ...
    name: "Success",
    desc: "This Pok\xE9mon's Speed is raised by 1 stage if it attacks and KOes another Pok\xE9mon.",
    rating: 3,
    num: 1e4
  },
  hotknife: {
    ...
    name: "Hot Knife",
    desc: "This Pok\xE9mon's Contact moves have a 30% chance of burning.",
    rating: 2,
    num: 10001
  },
  openmind: {
    ...
    name: "Open Mind",
    desc: "If Psychic Terrain is active, this Pok\xE9mon's speed is doubled.",
    rating: 3,
    num: 10002
  },
  voidbody: {
    ...
    name: "Void Body",
    desc: "Pok\xE9mon making contact with this Pok\xE9mon have their Attack lowered by 1 stage.",
    rating: 2,
    num: 10003
  },
  frightening: {
    ...
    name: "Frightening",
    desc: "On switch-in, this Pok\xE9mon lowers the SpA of opponents by 1 stage.",
    rating: 3.5,
    num: 10004
  },
  eternalice: {
    ...
    name: "Eternal Ice",
    desc: "This Pok\xE9mon's Ice power is 1.3x; It can't be burned; Fire power against it is halved.",
    rating: 4.5,
    num: 10005
  },
  leecher: {
  ...
  airionizer: {
    ...
    name: "Air Ionizer",
    desc: "This Pok\xE9mon SpA is raised 1 stage if hit by a Flying move; Flying immunity.",
    rating: 3,
    num: 10007
  },
  deepsea: {
  ...
  malware: {
    ...
    condition: {
      onStart(pokemon) {
        if (pokemon.species.id !== "surivexevirus")
          pokemon.formeChange("SurivExe-Virus");
      }
    },
  ...
  meteorpower: {
    ...
    name: "Meteor Power",
    desc: "This Pok\xE9mon gets 1.2 Atk and Def during a Sandstorm.",
    rating: 3,
    num: 10026
  },
  miceadaptation: {
  ...
  scary: {
    ...
    name: "Scary",
    desc: "On switch-in, this Pok\xE9mon lowers the Atk/SpA/Spe of opponents by 1 stage.",
    rating: 3.5,
    num: 10028
  },
  guardianoftheswamp: {
