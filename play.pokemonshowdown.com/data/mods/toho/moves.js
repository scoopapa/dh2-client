...
const Moves = {
  ...
  */
  ...
  bodyswap: {
    ...
    target: "self",
    onHit(pokemon) {
      if (!pokemon.baseSpecies.name.includes("Hecatia"))
        return;
  ...
  toxicspikes: {
    ...
    condition: {
      ...
      onSwitchIn(pokemon) {
        if (!pokemon.isGrounded() || pokemon.hasAbility("dexterity"))
          return;
  ...
  stickyweb: {
    ...
    condition: {
      ...
      onSwitchIn(pokemon) {
        if (!pokemon.isGrounded() || pokemon.hasAbility("dexterity") || pokemon.hasItem("heavydutyboots"))
          return;
