...
const Items = {
  ...
  adamantcrystal: {
    ...
    onBasePower(basePower, user, target, move2) {
      if (user.baseSpecies.num === 483 && (move2.type === "Steel" || move2.type === "Dragon")) {
  ...
  babiriberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if (move2.type === "Steel" && target.getMoveHitData(move2).typeMod > 0) {
  ...
  buggem: {
    ...
    onSourceTryPrimaryHit(target, source, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2.type === "Bug" && source.useItem()) {
  ...
  chartiberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if (move2.type === "Rock" && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["bypasssub"] && !(move2.infiltrates && this.gen >= 6);
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  chilanberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if (move2.type === "Normal" && (!target.volatiles["substitute"] || move2.flags["bypasssub"] || move2.infiltrates && this.gen >= 6)) {
        if (target.eatItem()) {
          this.debug("-50% reduction");
          this.add("-enditem", target, this.effect, "[weaken]");
          return this.chainModify(0.5);
  ...
  chopleberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if (move2.type === "Fighting" && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["bypasssub"] && !(move2.infiltrates && this.gen >= 6);
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  cobaberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if (move2.type === "Flying" && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["bypasssub"] && !(move2.infiltrates && this.gen >= 6);
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  colburberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if (move2.type === "Dark" && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["bypasssub"] && !(move2.infiltrates && this.gen >= 6);
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  darkgem: {
    ...
    onSourceTryPrimaryHit(target, source, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2.type === "Dark" && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    num: 562,
  ...
  dragongem: {
    ...
    onSourceTryPrimaryHit(target, source, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2.type === "Dragon" && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    num: 561,
  ...
  ejectbutton: {
    ...
    onAfterMoveSecondary(target, source, move2) {
      if (source && source !== target && target.hp && move2 && move2.category !== "Status" && !move2.flags["futuremove"]) {
  ...
  electricgem: {
    ...
    isGem: true,
    onSourceTryPrimaryHit(target, source, move2) {
      if (target === source || move2.category === "Status" || move2.flags["pledgecombo"])
        return;
      if (move2.type === "Electric" && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    num: 550,
  ...
  enigmaberry: {
    ...
    onHit(target, source, move2) {
      if (move2 && target.getMoveHitData(move2).typeMod > 0) {
        if (target.eatItem()) {
  ...
  fairygem: {
    ...
    onSourceTryPrimaryHit(target, source, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2.type === "Fairy" && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    num: 715,
  ...
  fightinggem: {
    ...
    onSourceTryPrimaryHit(target, source, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2.type === "Fighting" && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    num: 553,
  ...
  firegem: {
    ...
    onSourceTryPrimaryHit(target, source, move2) {
      if (target === source || move2.category === "Status" || move2.flags["pledgecombo"])
        return;
      if (move2.type === "Fire" && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    num: 548,
  ...
  flyinggem: {
    ...
    onSourceTryPrimaryHit(target, source, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2.type === "Flying" && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    num: 556,
  ...
  ghostgem: {
    ...
    onSourceTryPrimaryHit(target, source, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2.type === "Ghost" && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    num: 560,
  ...
  grassgem: {
    ...
    onSourceTryPrimaryHit(target, source, move2) {
      if (target === source || move2.category === "Status" || move2.flags["pledgecombo"])
        return;
      if (move2.type === "Grass" && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    num: 551,
  ...
  griseouscore: {
    ...
    onBasePowerPriority: 15,
    onBasePower(basePower, user, target, move2) {
      if (user.baseSpecies.num === 487 && (move2.type === "Ghost" || move2.type === "Dragon")) {
        return this.chainModify([4915, 4096]);
      }
    },
    onTakeItem(item, pokemon, source) {
  ...
  groundgem: {
    ...
    onSourceTryPrimaryHit(target, source, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2.type === "Ground" && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    num: 555,
  ...
  habanberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if (move2.type === "Dragon" && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["bypasssub"] && !(move2.infiltrates && this.gen >= 6);
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  icegem: {
    ...
    onSourceTryPrimaryHit(target, source, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2.type === "Ice" && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    num: 552,
  ...
  jabocaberry: {
    ...
    onDamagingHit(damage, target, source, move2) {
      if (move2.category === "Physical" && source.hp && source.isActive && !source.hasAbility("magicguard")) {
        if (target.eatItem()) {
  ...
  kasibberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if (move2.type === "Ghost" && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["bypasssub"] && !(move2.infiltrates && this.gen >= 6);
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  kebiaberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if (move2.type === "Poison" && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["bypasssub"] && !(move2.infiltrates && this.gen >= 6);
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  keeberry: {
    ...
    onAfterMoveSecondary(target, source, move2) {
      if (move2.category === "Physical") {
        if (move2.id === "present" && move2.heal)
          return;
        target.eatItem();
      }
    },
  ...
  lifeorb: {
    ...
    onAfterMoveSecondarySelf(source, target, move2) {
      if (source && source !== target && move2 && move2.category !== "Status" && !source.forceSwitchFlag) {
  ...
  lustrousglobe: {
    ...
    onBasePowerPriority: 15,
    onBasePower(basePower, user, target, move2) {
      if (user.baseSpecies.num === 484 && (move2.type === "Water" || move2.type === "Dragon")) {
        return this.chainModify([4915, 4096]);
      }
    },
    onTakeItem(item, pokemon, source) {
  ...
  metronome: {
    ...
    condition: {
      ...
      onTryMove(pokemon, target, move2) {
        ...
        if (this.effectState.lastMove === move2.id && pokemon.moveLastTurnResult) {
          this.effectState.numConsecutive++;
        } else if (pokemon.volatiles["twoturnmove"]) {
          if (this.effectState.lastMove !== move2.id) {
  ...
  micleberry: {
    ...
    condition: {
      duration: 2,
      onSourceAccuracy(accuracy, target, source, move2) {
        if (!move2.ohko) {
  ...
  normalgem: {
    ...
    onSourceTryPrimaryHit(target, source, move2) {
      if (target === source || move2.category === "Status" || move2.flags["pledgecombo"])
        return;
      if (move2.type === "Normal" && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    num: 564,
  ...
  occaberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if (move2.type === "Fire" && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["bypasssub"] && !(move2.infiltrates && this.gen >= 6);
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  passhoberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if (move2.type === "Water" && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["bypasssub"] && !(move2.infiltrates && this.gen >= 6);
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  payapaberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if (move2.type === "Psychic" && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["bypasssub"] && !(move2.infiltrates && this.gen >= 6);
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  poisongem: {
    ...
    onSourceTryPrimaryHit(target, source, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2.type === "Poison" && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    num: 554,
  ...
  powerherb: {
    onChargeMove(pokemon, target, move2) {
      if (pokemon.useItem()) {
        this.debug("power herb - remove charge turn for " + move2.id);
        this.attrLastMove("[still]");
        this.addMove("-anim", pokemon, move2.name, target);
        return false;
      }
    },
    name: "Power Herb",
  ...
  psychicgem: {
    ...
    onSourceTryPrimaryHit(target, source, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2.type === "Psychic" && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    num: 557,
  ...
  quickclaw: {
    ...
    onFractionalPriority(priority, pokemon, target, move2) {
      if (move2.category === "Status" && pokemon.hasAbility("myceliummight"))
        return;
  ...
  redcard: {
    ...
    onAfterMoveSecondary(target, source, move2) {
      if (source && source !== target && source.hp && target.hp && move2 && move2.category !== "Status") {
        if (!source.isActive || !this.canSwitch(source.side) || source.forceSwitchFlag || target.forceSwitchFlag) {
          return;
        }
        if (target.useItem(source)) {
          if (this.runEvent("DragOut", source, target, move2)) {
  ...
  rindoberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if (move2.type === "Grass" && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["bypasssub"] && !(move2.infiltrates && this.gen >= 6);
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  rockgem: {
    ...
    onSourceTryPrimaryHit(target, source, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2.type === "Rock" && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    num: 559,
  ...
  roseliberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if (move2.type === "Fairy" && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["bypasssub"] && !(move2.infiltrates && this.gen >= 6);
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  rowapberry: {
    ...
    onDamagingHit(damage, target, source, move2) {
      if (move2.category === "Special" && source.hp && source.isActive && !source.hasAbility("magicguard")) {
        this.damage(source.baseMaxhp / (target.hasAbility("ripen") ? 4 : 8), source, target);
      }
    },
    onEat() {
  ...
  safetygoggles: {
    ...
    onTryHit(pokemon, source, move2) {
      if (move2.flags["powder"] && pokemon !== source && this.dex.getImmunity("powder", pokemon)) {
        this.add("-activate", pokemon, "item: Safety Goggles", move2.name);
        return null;
      }
    },
    num: 650,
  ...
  shellbell: {
    ...
    onAfterMoveSecondarySelf(pokemon, target, move2) {
      if (move2.totalDamage && !pokemon.forceSwitchFlag) {
        this.heal(move2.totalDamage / 8, pokemon);
      }
    },
    num: 253,
    gen: 3
  ...
  shucaberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if (move2.type === "Ground" && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["bypasssub"] && !(move2.infiltrates && this.gen >= 6);
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  souldew: {
    ...
    onBasePowerPriority: 15,
    onBasePower(basePower, user, target, move2) {
      if (move2 && (user.baseSpecies.num === 380 || user.baseSpecies.num === 381) && (move2.type === "Psychic" || move2.type === "Dragon")) {
        return this.chainModify([4915, 4096]);
      }
    },
  ...
  steelgem: {
    ...
    onSourceTryPrimaryHit(target, source, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2.type === "Steel" && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    num: 563,
  ...
  stickybarb: {
    ...
    onHit(target, source, move2) {
      if (source && source !== target && !source.item && move2 && this.checkMoveMakesContact(move2, source, target)) {
  ...
  tangaberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if (move2.type === "Bug" && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["bypasssub"] && !(move2.infiltrates && this.gen >= 6);
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  wacanberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if (move2.type === "Electric" && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["bypasssub"] && !(move2.infiltrates && this.gen >= 6);
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  watergem: {
    ...
    onSourceTryPrimaryHit(target, source, move2) {
      if (target === source || move2.category === "Status" || move2.flags["pledgecombo"])
        return;
      if (move2.type === "Water" && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    num: 549,
  ...
  yacheberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if (move2.type === "Ice" && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["bypasssub"] && !(move2.infiltrates && this.gen >= 6);
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  vilevial: {
    ...
    onBasePowerPriority: 15,
    onBasePower(basePower, user, target, move2) {
      if (user.baseSpecies.num === -66 && ["Poison", "Flying"].includes(move2.type)) {
        return this.chainModify([4915, 4096]);
      }
    },
    onTakeItem(item, pokemon, source) {
