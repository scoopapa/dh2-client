  ...
  */
  fling: {
    ...
    onPrepareHit(target, source, move) {
      ...
      if (item.fling.damageCallback)
        move.damageCallback = item.fling.damageCallback;
      if (item.fling.multihit)
        move.multihit = item.fling.multihit;
      if (item.fling.priority)
        move.priority = item.fling.priority;
      if (item.fling.type)
        move.type = item.fling.type;
  ...
  recycle: {
    ...
    onHit(pokemon) {
      ...
      if (pokemon.item || !pokemon.lastItem || pokemon.lastItem === "Bottled Lightning")
        return false;
