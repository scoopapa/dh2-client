...
const Moves = {
  ...
  stealthrock: {
    ...
    condition: {
      ...
      onSwitchIn(pokemon) {
        if (pokemon.hasItem("heavydutyboots") || pokemon.hasItem("burndrive"))
          return;
    ...
    condition: {
      ...
      onDamagingHit(damage, target, source, move) {
        if (move.flags["contact"]) {
          this.boost({ atk: -2 }, source, target, void 0, true);
  ...
  technoblast: {
    ...
    onModifyType(move, pokemon) {
      if (pokemon.ignoringItem())
        return;
      move.type = this.runEvent("Drive", pokemon, void 0, move, "Normal");
    },
    secondary: void 0,
    target: "normal",
    type: "Normal",
  ...
  gulpmissile: {
    ...
    self: {
      onHit(source, target) {
        if (source.species.id !== "cramorantswimmer")
          return;
