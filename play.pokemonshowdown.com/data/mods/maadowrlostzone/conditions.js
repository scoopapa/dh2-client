...
const Conditions = {
  ...
  dolorakiumeffect: {
    ...
    onAnyDragOut(pokemon) {
      for (const target of this.getAllActive()) {
        if (target === pokemon)
          continue;
        if (target.baseSpecies.baseSpecies === "Dolorak" && target.hasItem("dolorakium") && target.volatiles["dolorakiumeffect"])
          return;
      }
      for (const target of this.getAllActive()) {
  ...
  qwilinhiumeffect: {
    ...
    onAnyDragOut(pokemon) {
      for (const target of this.getAllActive()) {
        if (target === pokemon)
          continue;
        if (target.species.name === "Qwilinh-Ascend" && target.hasItem("qwilinhium") && target.volatiles["qwilinhiumeffect"])
          return;
      }
      for (const target of this.getAllActive()) {
  ...
  sentinoyliumeffect: {
    ...
    onAnyDragOut(pokemon) {
      for (const target of this.getAllActive()) {
        if (target === pokemon)
          continue;
        if (target.baseSpecies.baseSpecies === "Sentinoyle" && target.hasItem("sentinoylium") && target.volatiles["sentinoyliumeffect"])
          return;
      }
      for (const target of this.getAllActive()) {
  ...
  sentinoyle: {
    ...
    onChangeBoost(boost, target, source, effect) {
      ...
      for (const stat in boost) {
        if (stat in boost && typeof boost[stat] === "number" && boost[stat] > 0) {
          delete boost[stat];
          showMsg = true;
        }
      }
  ...
  rampardiumeffect: {
    ...
    onAnyDragOut(pokemon) {
      for (const target of this.getAllActive()) {
        if (target === pokemon)
          continue;
        if (target.baseSpecies.baseSpecies === "Rampardos" && target.hasItem("rampardium") && target.volatiles["rampardiumeffect"])
          return;
      }
      for (const target of this.getAllActive()) {
  ...
  bastiodiumeffect: {
    ...
    onAnyDragOut(pokemon) {
      for (const target of this.getAllActive()) {
        if (target === pokemon)
          continue;
        if (target.baseSpecies.baseSpecies === "Bastiodon" && target.hasItem("bastiodium") && target.volatiles["bastiodiumeffect"])
          return;
      }
      for (const target of this.getAllActive()) {
  ...
  chiwengardiumeffect: {
    ...
    onAnyDragOut(pokemon) {
      for (const target of this.getAllActive()) {
        if (target === pokemon)
          continue;
        if (target.species.name === "Chiwengard-Ascend" && target.hasItem("chiwengardium") && target.volatiles["chiwengardiumeffect"])
          return;
      }
      for (const target of this.getAllActive()) {
  ...
  cthulaudiumeffect: {
    ...
    onAnyDragOut(pokemon) {
      for (const target of this.getAllActive()) {
        if (target === pokemon)
          continue;
        if (target.baseSpecies.baseSpecies === "Cthulauder" && target.hasItem("cthulaudium") && target.volatiles["cthulaudiumeffect"])
          return;
      }
      for (const target of this.getAllActive()) {
  ...
  lpsystemeffect: {
    ...
    onAnyDragOut(pokemon) {
      for (const target of this.getAllActive()) {
        if (target === pokemon)
          continue;
        if ((target.hasType("Bug") || target.hasType("Electric")) && target.hasItem("lpsystem") && target.volatiles["lpsystemeffect"])
          return;
      }
      for (const target of this.getAllActive()) {
  ...
  lpsystem: {
    ...
    onAfterMove(source, target, move) {
      if (target.volatiles["lzstartersystem"] || target === source)
        return;
      const stats = ["atk", "def", "spa", "spd", "spe", "accuracy", "evasion"];
      for (const activeTarget of this.getAllActive()) {
        if (!activeTarget.volatiles["siphoning"])
          continue;
        ...
        if (statLowered) {
          ...
          const ally = source.side.active.find(
            (ally2) => ally2 && ally2 !== source && !ally2.fainted && (ally2.hasType("Bug") || ally2.hasType("Electric") && ally2.volatiles["lpsystem"])
          );
          if (ally) {
  ...
  hpsystemeffect: {
    ...
    onAnyDragOut(pokemon) {
      for (const target of this.getAllActive()) {
        if (target === pokemon)
          continue;
        if ((target.hasType("Fire") || target.hasType("Water")) && target.hasItem("hpsystem") && target.volatiles["hpsystemeffect"])
          return;
      }
      for (const target of this.getAllActive()) {
  ...
  thirdeyesystemtrigger: {
    ...
    noCopy: true,
    onUpdate(pokemon) {
      if ((pokemon.hasType("Psychic") || pokemon.hasType("Normal") || pokemon.baseSpecies.name === "Aegislash-Light" && (pokemon.hasType("Electric") && pokemon.hasType("Fighting"))) && pokemon.hasItem("thirdeyesystem") && !pokemon.volatiles["thirdeyesystemeffect"]) {
  ...
  thirdeyesystemeffect: {
    ...
    onUpdate(source) {
      ...
      for (const pokemon of this.getAllActive()) {
        ...
        activated = true;
        if (!pokemon.volatiles["thirdeyesystem"] && (pokemon.hasType("Psychic") || pokemon.hasType("Normal") || pokemon.baseSpecies.name === "Aegislash-Light" && (pokemon.hasType("Electric") && pokemon.hasType("Fighting")))) {
    ...
    onAnyDragOut(pokemon) {
      for (const target of this.getAllActive()) {
        if (target === pokemon)
          continue;
        if ((target.hasType("Psychic") || target.hasType("Normal") || target.baseSpecies.name === "Aegislash-Light" && (target.hasType("Electric") && target.hasType("Fighting"))) && target.hasItem("thirdeyesystem") && target.volatiles["thirdeyesystemeffect"])
          return;
      }
      for (const target of this.getAllActive()) {
  ...
  thirdeyesystem: {
    ...
    onModifyMove(move, pokemon) {
      ...
      if (move.ignoreImmunity !== true) {
        if (pokemon.baseSpecies.name === "Aegislash-Light" && pokemon.hasType("Electric") && pokemon.hasType("Fighting")) {
          return;
        }
  ...
  mountainsystemeffect: {
    ...
    onAnyDragOut(pokemon) {
      for (const target of this.getAllActive()) {
        if (target === pokemon)
          continue;
        if ((target.hasType("Ice") || target.hasType("Fighting")) && target.hasItem("mountainsystem") && target.volatiles["mountainsystemeffect"])
          return;
      }
      for (const target of this.getAllActive()) {
  ...
  cursesystemeffect: {
    ...
    onAnyDragOut(pokemon) {
      for (const target of this.getAllActive()) {
        if (target === pokemon)
          continue;
        if ((target.hasType("Ghost") || target.hasType("Dark")) && target.hasItem("cursesystem") && target.volatiles["cursesystemeffect"])
          return;
      }
      for (const target of this.getAllActive()) {
      ...
      if (target && !target.fainted && !target.hasType(["Ghost", "Dark"]) && move.category !== "Status" && !target.volatiles["lzstartersystem"]) {
        ...
        const applyCurseDamage = () => {
          if (source.hp <= source.maxhp / 2) {
            ...
            curseDamage = Math.floor(target.maxhp / 16);
          }
          if (!target.fainted) {
  ...
  lzstartersystemtrigger: {
    ...
    noCopy: true,
    onUpdate(pokemon) {
      if ((pokemon.hasItem("matokodium") && pokemon.species.name === "Matokoda-Ascend" || pokemon.hasItem("piahchium") && pokemon.species.name === "Piahchi-Ascend" || pokemon.hasItem("zantium") && pokemon.species.name === "Zantui-Ascend") && !pokemon.volatiles["lzstartersystemeffect"]) {
  ...
  lzstartersystemeffect: {
    ...
    onAnyDragOut(pokemon) {
      for (const target of this.getAllActive()) {
        if (target === pokemon)
          continue;
        if ((target.hasItem("matokodium") && target.species.name === "Matokoda-Ascend" || target.hasItem("piahchium") && target.species.name === "Piahchi-Ascend" || target.hasItem("zantium") && target.species.name === "Zantui-Ascend") && target.volatiles["lzstartersystemeffect"])
          return;
      }
      for (const target of this.getAllActive()) {
        if (target.volatiles["lzstartersystem"]) {
  ...
  ecosystemeffect: {
    ...
    onAnyDragOut(pokemon) {
      for (const target of this.getAllActive()) {
        if (target === pokemon)
          continue;
        if ((target.hasType("Grass") || target.hasType("Rock")) && target.hasItem("ecosystem") && target.volatiles["ecosystemeffect"])
          return;
      }
      for (const target of this.getAllActive()) {
  ...
  minesystemeffect: {
    ...
    onAnyDragOut(pokemon) {
      for (const target of this.getAllActive()) {
        if (target === pokemon)
          continue;
        if ((target.hasType("Ground") || target.hasType("Dragon")) && target.hasItem("minesystem") && target.volatiles["minesystemeffect"])
          return;
      }
      for (const target of this.getAllActive()) {
  ...
  hexsystemeffect: {
    ...
    onAnyDragOut(pokemon) {
      for (const target of this.getAllActive()) {
        if (target === pokemon)
          continue;
        if ((target.hasType("Poison") || target.hasType("Fairy")) && target.hasItem("hexsystem") && target.volatiles["hexsystemeffect"])
          return;
      }
      for (const target of this.getAllActive()) {
  ...
  cloudsystemeffect: {
    ...
    onAnyDragOut(pokemon) {
      for (const target of this.getAllActive()) {
        if (target === pokemon)
          continue;
        if ((target.hasType("Flying") || target.hasType("Steel")) && target.hasItem("cloudsystem") && target.volatiles["cloudsystemeffect"])
          return;
      }
      for (const target of this.getAllActive()) {
  ...
  goodwillextension: {
    ...
    onChangeBoost(boost, target, source, effect) {
      ...
      const goodwillAllies = target.side.active.filter(
        (ally) => ally && ally !== target && ally.hasAbility("goodwill")
      );
      ...
      const stats = ["atk", "def", "spa", "spd", "spe", "accuracy", "evasion"];
      for (const stat of stats) {
        if (boost[stat] !== void 0 && boost[stat] < 0) {
          const protectingAlly = goodwillAllies.find(
            (ally) => ally.boosts[stat] < 0
            // Ensure ally has boosts property
          );
          if (protectingAlly) {
            boost[stat] = 0;
  ...
  psychout: {
    ...
    onDamage(damage, target, source, move) {
      if (this.effectState.hasTriggered)
        return damage;
      if (damage >= target.hp) {
        const hasPsychOutAlly = target.side.active.some(
          (ally) => ally !== target && !ally.fainted && ally.hasAbility("psychout")
        );
        if (hasPsychOutAlly) {
  ...
  skyriderally: {
    ...
    onStart(pokemon) {
      if (!pokemon.types.includes("Steel")) {
        pokemon.types = [...pokemon.types, "Steel"];
    ...
    onEnd(pokemon) {
      if (pokemon.types.includes("Steel")) {
        pokemon.types = pokemon.types.filter((type) => type !== "Steel");
