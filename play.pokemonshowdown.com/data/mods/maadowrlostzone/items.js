...
const Items = {
  ...
  chargeorb: {
    ...
    onResidual(pokemon) {
      if (pokemon.item === "chargeorb") {
        this.boost({ spd: 1 });
        if (!pokemon.hasType("Ground")) {
          pokemon.trySetStatus("par", pokemon);
        }
        this.add("-activate", pokemon, "item: Charge Orb");
        pokemon.useItem();
      }
    },
    num: -1210,
  ...
  dolorakium: {
    ...
    onTakeItem: false,
    num: -1225,
    desc: "All Pok\xE9mon gain +1 crit ratio.",
    ...
    onUpdate(pokemon) {
      if (!pokemon.side.sideConditions["dolorakiumtrigger"]) {
        ...
        if (pokemon.baseSpecies.baseSpecies === "Dolorak") {
          ...
          this.add("-anim", pokemon, "Geomancy");
          this.add("-message", `The Dolorakium has been activated on ${pokemon.side.name}'s side! All Pok\xE9mon gain +1 crit ratio.`);
        }
      }
    }
  },
  ...
  qwilinhium: {
    ...
    num: -1227,
    desc: "Mega: Pok\xE9mon with stat drops take 25% less damage from a move.",
    // Check if the item can be activated
    onUpdate(pokemon) {
      if (!pokemon.side.sideConditions["qwilinhiumtrigger"]) {
        ...
        if (pokemon.species.name === "Qwilinh-Ascend") {
          ...
          this.add("-anim", pokemon, "Geomancy");
          this.add("-message", `The Qwilinhium has been activated on ${pokemon.side.name}'s side! Pok\xE9mon with stat drops take 25% less damage from a move.`);
        }
      }
    }
  },
  ...
  sentinoylium: {
    ...
    num: -1230,
    desc: "Mega: Pok\xE9mon can't raise their stats.",
    // Check if the item can be activated
    onUpdate(pokemon) {
      if (!pokemon.side.sideConditions["sentinoyliumtrigger"]) {
        ...
        if (pokemon.species.name === "Sentinoyle-Ascend") {
          ...
          this.add("-anim", pokemon, "Geomancy");
          this.add("-message", `The Sentinoylium has been activated on ${pokemon.side.name}'s side! Pok\xE9mon can't raise their stats.`);
        }
      }
    }
  },
  ...
  rampardium: {
    ...
    onTakeItem: false,
    num: -1231,
    desc: "Pok\xE9mon do 25% more damage with a super effective move.",
    // Check if the item can be activated
    onUpdate(pokemon) {
      if (!pokemon.side.sideConditions["rampardiumtrigger"]) {
        ...
        if (pokemon.baseSpecies.baseSpecies === "Rampardos") {
          ...
          this.add("-anim", pokemon, "Geomancy");
          this.add("-message", `The Rampardium has been activated on ${pokemon.side.name}'s side! Pok\xE9mon do 25% more damage with a super effective move.`);
        }
      }
    }
  },
  ...
  bastiodium: {
    ...
    onTakeItem: false,
    num: -1232,
    desc: "Pok\xE9mon receive 25% less damage from a super effective move.",
    // Check if the item can be activated
    onUpdate(pokemon) {
      if (!pokemon.side.sideConditions["bastiodiumtrigger"]) {
        ...
        if (pokemon.baseSpecies.baseSpecies === "Bastiodon") {
          ...
          this.add("-anim", pokemon, "Geomancy");
          this.add("-message", `The Bastiodium has been activated on ${pokemon.side.name}'s side! Pok\xE9mon receive 25% less damage from a super effective move.`);
        }
      }
    }
  },
    ...
    onUpdate(pokemon) {
      if (!pokemon.side.sideConditions["chiwengardiumtrigger"]) {
        ...
        if (pokemon.species.name === "Chiwengard-Ascend") {
          ...
          this.add("-anim", pokemon, "Geomancy");
          this.add("-message", `The Chiwengardium has been activated on ${pokemon.side.name}'s side! Pok\xE9mon with stat drops take 25% less damage from a move.`);
        }
      }
    }
  },
  ...
  cthulaudium: {
    ...
    onTakeItem: false,
    num: -1236,
    desc: "Non Dark Pok\xE9mon are under Torment effect.",
    // Check if the item can be activated
    onUpdate(pokemon) {
      if (!pokemon.side.sideConditions["cthulaudiumtrigger"]) {
        ...
        if (pokemon.baseSpecies.baseSpecies === "Cthulauder") {
          ...
          this.add("-anim", pokemon, "Geomancy");
          this.add("-message", `The Cthulaudium has been activated on ${pokemon.side.name}'s side! Non Dark Pok\xE9mon are under Torment effect.`);
        }
      }
    }
  },
  ...
  lpsystem: {
    ...
    onTakeItem: false,
    num: -1242,
    desc: "Bug and Electric Pok\xE9mon recover 1/8 of their health and share half of it with the other when lowering a target's stat.",
    // Check if the item can be activated
    onUpdate(pokemon) {
      if (!pokemon.side.sideConditions["lpsystemtrigger"]) {
        ...
        if (pokemon.hasType("Bug") || pokemon.hasType("Electric")) {
          ...
          this.add("-anim", pokemon, "Geomancy");
          this.add("-message", `The LP System has been activated on ${pokemon.side.name}'s side! Bug and Electric Pok\xE9mon recover 1/8 of their HP and share half of it with the other when lowering a target's stat.`);
        }
      }
    }
  },
  ...
  hpsystem: {
    ...
    onTakeItem: false,
    num: -1243,
    desc: "Fire and Water Pok\xE9mon burn target if dealing super effective damage.",
    // Check if the item can be activated
    onUpdate(pokemon) {
      if (!pokemon.side.sideConditions["hpsystemtrigger"]) {
        ...
        if (pokemon.hasType("Fire") || pokemon.hasType("Water")) {
          ...
          this.add("-anim", pokemon, "Geomancy");
          this.add("-message", `The HP System has been activated on ${pokemon.side.name}'s side! Fire and Water Pok\xE9mon burn target if dealing super effective damage.`);
        }
      }
    }
  },
  ...
  thirdeyesystem: {
    ...
    onTakeItem: false,
    num: -1244,
    desc: "Psychic and Normal Pok\xE9mon bypass immunity with their respective types.",
    // Check if the item can be activated
    onUpdate(pokemon) {
      if (!pokemon.side.sideConditions["thirdeyesystemtrigger"]) {
        ...
        if (pokemon.hasType("Psychic") || pokemon.hasType("Normal") || pokemon.baseSpecies.name === "Aegislash-Light" && pokemon.hasType("Electric") && pokemon.hasType("Fighting")) {
          pokemon.side.addSideCondition("thirdeyesystemtrigger");
          this.add("-sidestart", pokemon.side, "Third Eye System");
          this.add("-anim", pokemon, "Geomancy");
          this.add("-message", `The Third Eye System has been activated on ${pokemon.side.name}'s side! Psychic and Normal Pok\xE9mon bypass immunity with their respective types.`);
        }
      }
    }
  },
  ...
  mountainsystem: {
    ...
    onTakeItem: false,
    num: -1245,
    desc: "Ice and Fighting Pok\xE9mon take half damage at or below 50% HP.",
    // Check if the item can be activated
    onUpdate(pokemon) {
      if (!pokemon.side.sideConditions["mountainsystemtrigger"]) {
        ...
        if (pokemon.hasType("Ice") || pokemon.hasType("Fighting")) {
          ...
          this.add("-anim", pokemon, "Geomancy");
          this.add("-message", `The Mountain System has been activated on ${pokemon.side.name}'s side! Ice and Fighting Pok\xE9mon take half damage at or below 50% HP.`);
        }
      }
    }
  },
  cursesystem: {
    ...
    onTakeItem: false,
    num: -1246,
    desc: "Ghost and Dark Pok\xE9mon do 1/8 chip damage and recover if at or below 50% HP, else 1/16. Does not affect themselves.",
    // Check if the item can be activated
    onUpdate(pokemon) {
      if (!pokemon.side.sideConditions["cursesystemtrigger"]) {
        ...
        if (pokemon.hasType("Ghost") || pokemon.hasType("Dark")) {
          ...
          this.add("-anim", pokemon, "Geomancy");
          this.add("-message", `The Curse System has been activated on ${pokemon.side.name}'s side! Ghost and Dark Pok\xE9mon do 1/8 chip damage and recover if at or below 50% HP, else 1/16. Does not affect themselves.`);
        }
      }
    }
  },
  ecosystem: {
    ...
    onTakeItem: false,
    num: -1247,
    desc: "Grass and Rock Pok\xE9mon cannot have their stats lowered by another Pok\xE9mon.",
    // Check if the item can be activated
    onUpdate(pokemon) {
      if (!pokemon.side.sideConditions["ecosystemtrigger"]) {
        ...
        if (pokemon.hasType("Grass") || pokemon.hasType("Rock")) {
          ...
          this.add("-anim", pokemon, "Geomancy");
          this.add("-message", `The Eco System has been activated on ${pokemon.side.name}'s side! Grass and Rock Pok\xE9mon can't have their stats lowered by another Pok\xE9mon.`);
        }
      }
    }
  },
  minesystem: {
    ...
    onTakeItem: false,
    num: -1248,
    desc: "Ground and Dragon Pok\xE9mon cannot be statused.",
    // Check if the item can be activated
    onUpdate(pokemon) {
      if (!pokemon.side.sideConditions["minesystemtrigger"]) {
        ...
        if (pokemon.hasType("Ground") || pokemon.hasType("Dragon")) {
          ...
          this.add("-anim", pokemon, "Geomancy");
          this.add("-message", `The Mine System has been activated on ${pokemon.side.name}'s side! Ground and Dragon Pok\xE9mon can't be statused.`);
        }
      }
    }
  },
  hexsystem: {
    ...
    onTakeItem: false,
    num: -1249,
    desc: "Poison and Fairy Pok\xE9mon inflict Torment when attacked. No effect against themselves.",
    // Check if the item can be activated
    onUpdate(pokemon) {
      if (!pokemon.side.sideConditions["hexsystemtrigger"]) {
        ...
        if (pokemon.hasType("Poison") || pokemon.hasType("Fairy")) {
          ...
          this.add("-anim", pokemon, "Geomancy");
          this.add("-message", `The Hex System has been activated on ${pokemon.side.name}'s side! Poison and Fairy Pok\xE9mon inflict Torment when attacked. No effect against themselves.`);
        }
      }
    }
  },
  cloudsystem: {
    ...
    onTakeItem: false,
    num: -1250,
    desc: "Flying and Steel Pok\xE9mon take half indirect damage and do 20% more damage with recoil moves.",
    // Check if the item can be activated
    onUpdate(pokemon) {
      if (!pokemon.side.sideConditions["cloudsystemtrigger"]) {
        ...
        if (pokemon.hasType("Flying") || pokemon.hasType("Steel")) {
          ...
          this.add("-anim", pokemon, "Geomancy");
          this.add("-message", `The Cloud System has been activated on ${pokemon.side.name}'s side! Flying and Steel Pok\xE9mon take half indirect damage and do 20% more damage with recoil moves.`);
        }
      }
    }
  },
