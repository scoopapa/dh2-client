  ...
  */
  ...
  psychicgem: {
    ...
    onAfterMoveSecondarySelf(source, target, move) {
      if (!move || !target)
        return;
      if (this.effectState.psychicGem)
        return;
  ...
  firestartergem: {
    ...
    onAfterMoveSecondarySelf(source, target, move) {
      if (!move || !target)
        return;
      if (this.effectState.firestarterGem)
        return;
  ...
  waterstartergem: {
    ...
    onAfterMoveSecondarySelf(source, target, move) {
      if (!move || !target)
        return;
      if (this.effectState.waterstarterGem)
        return;
  ...
  grassstartergem: {
    ...
    onAfterMoveSecondarySelf(source, target, move) {
      if (!move || !target)
        return;
      if (this.effectState.grassstarterGem)
        return;
