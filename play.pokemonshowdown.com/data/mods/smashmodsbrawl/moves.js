...
const Moves = {
  ...
  fisheater: {
    ...
    onHit(target, source, move) {
      if (!target.side.fishingTokens || target.side.fishingTokens <= 0 || source.volatiles["stockpile3"])
        return false;
  ...
  fishingterrain: {
    ...
    condition: {
      ...
      onBasePower(basePower2, attacker, defender, move) {
        let mod = 1;
  ...
  roaroftime: {
    ...
    condition: {
      ...
      onDamagingHit(damage, target, source, move) {
        this.boost({ spa: 1 }, target, source, void 0, true);
