...
const Moves = {
  ...
  "inverseroom": {
    ...
    basePower: 0,
    category: "Status",
    shortDesc: "For 5 turns, all Pok\xE9mon on the field are resistant to normally super-effective types and weak to normally not-very-effective or ineffective types (as in Inverse Battles) ",
    id: "inverseroom",
    name: "Inverse Room",
    pp: 5,
    priority: 0,
  ...
  "stickyweb": {
    ...
    condition: {
      ...
      onSwitchIn(pokemon) {
        if (!pokemon.isGrounded() || pokemon.hasItem("heavydutyboots") || pokemon.hasItem("safetysocks"))
          return;
  ...
  gmaxsteelsurge: {
    ...
    condition: {
      ...
      onSwitchIn(pokemon) {
        if (pokemon.hasItem("heavydutyboots") || pokemon.hasItem("safetysocks"))
          return;
