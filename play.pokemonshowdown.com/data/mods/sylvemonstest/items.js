...
const Items = {
  ...
  "reversecore": {
    ...
    onEffectiveness(typeMod, target, type, move) {
      if (move && this.dex.getImmunity(move, type) === false)
        return 1;
      return typeMod * -1;
    },
  ...
  "adamantorb": {
    ...
    onTakeItem(item, source) {
      if (source.baseSpecies.baseSpecies === "Dialga")
        return false;
      return true;
    }
  },
  "deepseascale": {
    inherit: true,
    onTakeItem(item, source) {
      if (source.baseSpecies.baseSpecies === "Clamperl")
        return false;
      return true;
    }
  },
  ...
  "luckypunch": {
    inherit: true,
    onTakeItem(item, source) {
      if (source.baseSpecies.baseSpecies === "Chansey")
        return false;
      return true;
    }
  },
  "lustrousorb": {
    inherit: true,
    onTakeItem(item, source) {
      if (source.baseSpecies.baseSpecies === "Palkia")
        return false;
      return true;
    }
  },
  "metalpowder": {
    inherit: true,
    onTakeItem(item, source) {
      if (source.baseSpecies.baseSpecies === "Ditto")
        return false;
      return true;
    }
  },
  ...
  "graduationscale": {
    ...
    onTakeItem(item, source) {
      if (source.baseSpecies.baseSpecies === "Wishiwashi" || source.baseSpecies.baseSpecies === "Wishiwashi-School")
        return false;
      return true;
    },
    fling: {
  ...
  ragecandybar: {
    ...
    onTakeItem(item, source) {
      if (source.baseSpecies.baseSpecies === "Darmanitan")
        return false;
      return true;
    },
    itemUser: ["Darmanitan"],
  ...
  "ringtarget": {
    ...
    desc: "If a Pok\xE9mon holds this item, it will ignore any type-based immunity when attacking."
  },
  "agonyboots": {
    id: "agonyboots",
    name: "Agony Boots",
  ...
  "forecastofsun": {
    ...
    desc: "If the holder has the ability Forecast, this Pok\xE9mon summons sun when it is sent out.",
    fling: {
      basePower: 10
    },
    onTakeItem: false,
  ...
  "forecastofrain": {
    ...
    desc: "If the holder has the ability Forecast, this Pok\xE9mon summons rain when it is sent out.",
    fling: {
      basePower: 10
    },
    onTakeItem: false,
  ...
  "forecastofsand": {
    ...
    desc: "If the holder has the ability Forecast, this Pok\xE9mon summons sand when it is sent out.",
    fling: {
      basePower: 10
    },
    onTakeItem: false,
  ...
  "forecastofhail": {
    ...
    desc: "If the holder has the ability Forecast, this Pok\xE9mon summons hail when it is sent out.",
    fling: {
      basePower: 10
    },
    onTakeItem: false,
  ...
  "forecastofshadows": {
    ...
    desc: "If the holder has the ability Forecast, this Pok\xE9mon summons shadow sky when it is sent out.",
    fling: {
      basePower: 10
    },
    onTakeItem: false,
  ...
  "forecastofwind": {
    ...
    desc: "If the holder has the ability Forecast, this Pok\xE9mon summons air current when it is sent out.",
    fling: {
      basePower: 10
    },
    onTakeItem: false,
