  ...
  passiveaggressive: {
    ...
    condition: {
      ...
      onAllyTryMove(source, target, move) {
        ...
        this.actions.useMove("echosnap", source);
      },
      onEnd(pokemon) {
    ...
    condition: {
      ...
      onFieldStart(field, source, effect) {
        if (effect?.effectType === "Ability") {
          ...
          this.add("-message", "Grounded Fighting Pok\xE9mon have +1 crit ratio and 10% accuracy more.");
          this.add("-message", "Fighting moves of grounded Pok\xE9mon give +1 Atk if user moved last.");
        } else {
