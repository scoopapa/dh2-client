...
const Abilities = {
  ...
  //
  vigorsurge: {
    desc: "On switch-in, this Pok\xE9mon summons Vigorr Terrain for 5 turns. During the effect, grounded Fighting Pok\xE9mon have +1 crit and 10% acc. Fighting moves of grounded Pok\xE9mon grant +1 Atk if the user moved last. Camouflage transforms the user into a Fighting-type. Lasts for 8 turns if the user is holding a Terrain Extender (such as through Skill Swap).",
  ...
  photolysis: {
    desc: "On switch-in, the weather becomes Acidic Rain. It lasts for 5 turns. During this effect, Steel Pok\xE9mon become vulnerable to damaging Poison moves. At the end of each turn, non Poison Pok\xE9mon loose 1/16 of their HP.",
  ...
  thundercloud: {
    onPrepareHit(source, target, move) {
      if (!move || !source || !source.isActive)
        return;
      if (source.getAbility().name !== "Thundercloud")
        return;
