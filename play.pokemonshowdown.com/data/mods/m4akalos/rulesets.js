...
const Rulesets = {
  megadatamod: {
    ...
    onBegin() {
      ...
      this.add("-message", `Right now, we're working on giving new Mega Evolutions to a variety of Pok\xE9mon in a Kalos Pok\xE9dex-based format. The only Mega Evolutions allowed are our new ones!`);
