...
const Items = {
  ...
  unoreversecard: {
    ...
    spritenum: 608,
    onTakeItem(item, pokemon, source) {
      if (this.suppressingAttackEvents(pokemon) || !pokemon.hp)
        return;
      if (!this.activeMove)
  ...
  souldew: {
    ...
    onBasePower(basePower, user, target, move) {
      if (move && (user.baseSpecies.num === 380 && (move.type === "Fairy" || move.type === "Dragon")) || user.baseSpecies.num === 381 && (move.type === "Dragon" || move.type === "Electric")) {
