    ...
    canMegaEvo(pokemon) {
      ...
      if (item.megaStone) {
        if (item.megaStone === pokemon.baseSpecies.name)
          return null;
        else if (item.name === "Lycanite" && pokemon.species.name === "Lycanroc-Midnight")
          return "Lycanroc-Midnight-Mega";
        else if (item.name === "Lycanite" && pokemon.species.name === "Lycanroc-Dusk")
          return "Lycanroc-Dusk-Mega";
        else if (item.name === "Slowkinite" && pokemon.species.name === "Slowking-Galar")
          return "Slowking-Galar-Mega";
        else if (item.name === "Gourgeite" && pokemon.species.name === "Gourgeist-Small")
          return "Gourgeist-Small-Mega";
        else if (item.name === "Gourgeite" && pokemon.species.name === "Gourgeist-Large")
          return "Gourgeist-Large-Mega";
        else if (item.name === "Gourgeite" && pokemon.species.name === "Gourgeist-Super")
          return "Gourgeist-Super-Mega";
        else if (item.name === "Reginite" && pokemon.species.name === "Regice")
          return "Regice-Mega";
        else if (item.name === "Reginite" && pokemon.species.name === "Registeel")
          return "Registeel-Mega";
        else if (item.name === "Meowsticite" && pokemon.species.name === "Meowstic-F")
          return "Meowstic-F-Mega";
        else if (item.name === "Sawsbuckite" && pokemon.species.id === "sawsbucksummer")
          return "Sawsbuck-Summer-Mega";
        else if (item.name === "Sawsbuckite" && pokemon.species.id === "sawsbuckautumn")
          return "Sawsbuck-Autumn-Mega";
        else if (item.name === "Sawsbuckite" && pokemon.species.id === "sawsbuckwinter")
          return "Sawsbuck-Winter-Mega";
        else if (item.name === "Toxtricitite" && pokemon.species.name === "Toxtricity-Low-Key")
