...
const Scripts = {
  ...
  pokemon: {
    ignoringItem() {
      ...
      this.battle.gen >= 5 && !this.isActive || !this.getItem().ignoreKlutz && this.hasAbility("klutz") || this.volatiles["embargo"] || this.battle.field.pseudoWeather["magicroom"] || this.battle.field.pseudoWeather["mindfuck"]);
    },
    ignoringAbility() {
      ...
      for (const pokemon of this.battle.getAllActive()) {
        ...
        if (this.battle.field.pseudoWeather["fable"] && evilAbilities.includes(pokemon.ability))
          return true;
      }
      return false;
    },
