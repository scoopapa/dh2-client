...
const Moves = {
  ...
  cursedfield: {
    ...
    condition: {
      ...
      onSwitchIn(pokemon) {
        let dmgDiv = 8;
        if (this.dex.dataCache.scootopia.getImmunity(pokemon, "cursedfield"))
          return;
        if (pokemon.hasAbility("overcoat"))
          dmgDiv = 16;
      ...
      onResidual(pokemon) {
        ...
        if (this.dex.dataCache.scootopia.getImmunity(pokemon, "cursedfield"))
          return;
        if (pokemon.m.fieldTurns > pokemon.activeTurns)
          pokemon.m.fieldTurns = pokemon.activeTurns;
  ...
  blessedfield: {
    ...
    condition: {
      ...
      onSwitchIn(pokemon) {
        if (this.dex.dataCache.scootopia.getImmunity(pokemon, "blessedfield"))
          return;
  ...
  rainofmeteors: {
    ...
    condition: {
      ...
      onResidual(pokemon) {
        ...
        if (this.dex.dataCache.scootopia.getImmunity(pokemon, "rainofmeteors"))
          return;
        let dmgDiv = 8;
        if (pokemon.hasType("Steel") || pokemon.hasType("Rock") || pokemon.hasAbility("Overcoat"))
          dmgDiv = 16;
  ...
  rainofdew: {
    ...
    condition: {
      ...
      onResidual(pokemon) {
        ...
        if (this.dex.dataCache.scootopia.getImmunity(pokemon, "rainofdew"))
          return;
        let dmgDiv = 16;
        if (!pokemon.effectiveWeather() === "raindance") {
          if (pokemon.hasAbility("Rain Dish"))
            dmgDiv = 8;
  ...
  silentdomain: {
    ...
    condition: {
      ...
      onDisableMove(pokemon) {
        if (this.dex.dataCache.scootopia.getImmunity(pokemon, "silentdomain"))
          return;
      ...
      onResidual(pokemon) {
        ...
        for (const boost in pokemon.boosts) {
          if (pokemon.boosts[boost] > 0 && !this.dex.dataCache.scootopia.getImmunity(pokemon, "silentdomain"))
            toBoost[boost] = -1;
          else if (pokemon.boosts[boost] < 0)
            toBoost[boost] = 1;
        }
  ...
  stellaralignment: {
    ...
    condition: {
      ...
      onResidual(pokemon) {
        ...
        if (this.dex.dataCache.scootopia.getImmunity(pokemon, "stellaralignment"))
          return;
        pokemon.m.fieldTurns++;
        if (pokemon.m.fieldTurns > pokemon.activeTurns)
          pokemon.m.fieldTurns = pokemon.activeTurns;
  ...
  chaoticweather: {
    ...
    condition: {
      ...
      onFieldStart(field, source, effect) {
        ...
        for (const side of field.battle.sides) {
          for (const pokemon of side.active) {
            if (pokemon.hasAbility("windrider"))
      ...
      onResidual(pokemon) {
        ...
        if (this.dex.dataCache.scootopia.getImmunity(pokemon, "chaoticweather"))
          return;
  ...
  chaoticterrain: {
    ...
    condition: {
      ...
      onResidual(pokemon) {
        ...
        if (this.dex.dataCache.scootopia.getImmunity(pokemon, "chaoticterrain"))
          return;
  ...
  iconoblast: {
    ...
    onModifyMove(move, pokemon, target) {
      ...
      if (!wMove)
        return;
      wMove = this.dex.moves.get(wMove);
      if (wMove.pseudoWeather)
        move.pseudoWeather = wMove.pseudoWeather;
    },
    secondary: null,
    target: "normal",
    type: "Normal"
  ...
  moonlight: {
    ...
    onHit(pokemon) {
      ...
      if (this.dex.dataCache.scootopia.getWorldEffect(pokemon) === "stellaralignment")
        factor = factor < 0.5 ? 0.667 : 0.334;
  ...
  weatherball: {
    ...
    onModifyType(move, pokemon) {
      ...
      if (move.type == "Normal" && this.dex.dataCache.scootopia.getWorldEffect(pokemon) === "rainofdew")
        move.type = "Water";
    },
    onModifyMove(move, pokemon) {
      ...
      if (move.basePower == 50 && this.dex.dataCache.scootopia.getWorldEffect(pokemon) === "rainofdew")
        move.basePower *= 2;
    }
  },
  solarbeam: {
