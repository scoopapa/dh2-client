...
const Items = {
  ...
  slowkinite: {
    ...
    itemUser: ["Slowking"],
    onTakeItem(item, source) {
      if (source.species.name.startsWith("Slowking"))
        return false;
      return true;
    },
    num: -1025,
  ...
  reginite: {
    ...
    itemUser: ["Regirock"],
    onTakeItem(item, source) {
      if (source.baseSpecies.baseSpecies === "Regirock")
        return false;
      if (source.baseSpecies.baseSpecies === "Regice")
        return false;
      if (source.baseSpecies.baseSpecies === "Registeel")
        return false;
      return true;
    },
    num: -1059,
  ...
  sawsbuckite: {
    ...
    onTakeItem(item, source) {
      if (item.megaEvolves === source.baseSpecies.baseSpecies)
        return false;
      if (source.baseSpecies.baseSpecies === "Delibird")
        return false;
      return true;
    },
    num: -1068,
  ...
  ninetalesite: {
    ...
    onTakeItem(item, source) {
      if (source.species.name.startsWith("Ninetales-Alola"))
        return false;
      return true;
    },
    num: -1078,
  ...
  electrodite: {
    name: "Electrodite",
    // sorry, Kero, no Thermite for you
    spritenum: 578,
  ...
  wormadamite: {
    ...
    onTakeItem(item, source) {
      if (source.species.name.startsWith("Wormadam-Sandy"))
        return false;
      return true;
    },
    num: -1003,
