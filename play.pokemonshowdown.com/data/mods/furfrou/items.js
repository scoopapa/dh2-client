...
const Items = {
  ...
  magneticsoles: {
    ...
    condition: {
      ...
      onModifyAtk(atk, pokemon) {
        if (this.effectState.bestStat !== "atk" || pokemon.ignoringItem())
          return;
      ...
      onModifyDef(def, pokemon) {
        if (this.effectState.bestStat !== "def" || pokemon.ignoringItem())
          return;
      ...
      onModifySpA(spa, pokemon) {
        if (this.effectState.bestStat !== "spa" || pokemon.ignoringItem())
          return;
      ...
      onModifySpD(spd, pokemon) {
        if (this.effectState.bestStat !== "spd" || pokemon.ignoringItem())
          return;
        this.debug("Magnetic Soles spd boost");
        return this.chainModify([5325, 4096]);
      },
      onModifySpe(spe, pokemon) {
        if (this.effectState.bestStat !== "spe" || pokemon.ignoringItem())
          return;
  ...
  korrasshades: {
    ...
    onTakeItem(item, source) {
      if (source.baseSpecies.baseSpecies === "Mawile")
        return false;
      return true;
    },
  ...
  necasabre: {
    ...
    onTakeItem(item, source) {
      if (source.baseSpecies.baseSpecies === "Foton")
        return false;
      return true;
    },
